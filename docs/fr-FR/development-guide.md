...
```
SiliconLife.Common/
├── AI/                    # Implémentations des clients IA et fabriques (13 clients : Ollama, DashScope, DeepSeek, Zhipu, Ernie, Hunyuan, MiniMax, Moonshot, SiliconFlow, VolcengineArk, Herdsman, LongCat, QiniuAI)
