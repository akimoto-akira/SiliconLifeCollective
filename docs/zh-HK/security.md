...
[English](../en/security.md) | [Deutsch](../de-DE/security.md) | [中文](../zh-CN/security.md) | **繁體中文** | [Español](../es-ES/security.md) | [日本語](../ja-JP/security.md) | [한국어](../ko-KR/security.md) | [Čeština](../cs-CZ/security.md) | [Русский](../ru-RU/security.md)
...
查詢優先級為：**1. 頻率快取 → 2. 回呼函式 → 3. 分支判斷（IsCurator/GlobalACL）**
...
- **使用者選擇，非自動檢測**：當觸發詢問使用者時，使用者選擇是否將資源新增到快取。
...
自我進化（類重寫）引入了獨特的安全風險。系統使用**分層策略**緩解它們：
