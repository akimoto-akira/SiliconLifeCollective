...
[English](../en/architecture.md) | [中文](../zh-CN/architecture.md) | **繁體中文** | [Español](../es-ES/architecture.md) | [日本語](../ja-JP/architecture.md) | [한국어](../ko-KR/architecture.md) | [Čeština](../cs-CZ/architecture.md) | [Русский](../ru-RU/architecture.md)

## 雙版本架構

本項目提供兩個實現版本，共享相同的架構設計，但在儲存和效能優化方面有所不同：
...
- **角色說明**：作為架構驗證的基準實現，提供簡單可靠的運行方式，適合初次接觸本項目、開發調試或資料安全優先的場景
...
- 可通過 Web UI（UsageController）和 `TokenAuditTool`（僅主理人）存取
...
Web UI 遵循**類 MVC 模式**，23 個控制器處理不同方面：
