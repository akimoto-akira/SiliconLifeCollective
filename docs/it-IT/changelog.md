...
- **SiliconLife.Fast** : Versione principale di produzione. Applicazione desktop multipiattaforma (Windows / macOS / Linux), storage in memoria SpeedyPack + persistenza asincrona, ottimizzazione approfondita delle prestazioni.
...
- `9e07b27` - Correggere discrepanze della documentazione francese (fr-FR) con il codice sorgente (ref task-307)
  - 10 file modificati

- `9e3be72` - Correggere discrepanze della documentazione tedesca (de-DE) con il codice sorgente (ref task-308)
  - 5 file modificati

- `2bc7151` - Correggere discrepanze della documentazione spagnola (es-ES) con il codice sorgente (ref task-309)
  - 13 file modificati

- `f95088e` - Correggere discrepanze della documentazione italiana (it-IT) con il codice sorgente (ref task-310)
  - 11 file modificati

- `6ea9f4a` - Correggere discrepanze della documentazione polacca (pl-PL) con il codice sorgente (ref task-311)
  - 16 file modificati

- `7646923` - Correggere discrepanze della documentazione portoghese (pt-PT) con il codice sorgente (ref task-312)
  - 12 file modificati

- `7eaf9db` - Correggere discrepanze della documentazione ceca (cs-CZ) con il codice sorgente (ref task-313)
  - 12 file modificati
...
#### Nuove funzionalità
- `99eca78` - Aggiunta di 'Visualizza archiviazione (sola lettura)' al menu contestuale, chiamata intra-processo a Speedy.Manager (ref task-301)
  - 26 file modificati

#### Correzioni di coerenza della documentazione
- `7f65cf1` - Correggere discrepanze della documentazione zh-CN con il codice sorgente (ref task-303)
  - 15 file modificati

- `a9e2a2c` - Correggere discrepanze della documentazione inglese (en) con il codice sorgente (ref task-302)
  - 9 file modificati

- `2549105` - Correggere discrepanze della documentazione cinese tradizionale (zh-HK) con il codice sorgente (ref task-304)
  - 12 file modificati

- `277eb50` - Correggere discrepanze della documentazione giapponese con il codice sorgente (ref task-305)
  - 10 file modificati

- `edce413` - Correggere discrepanze della documentazione coreana (ko-KR) con il codice sorgente (ref task-306)
  - 18 file modificati

- `f2adcae` - Correggere incoerenze della documentazione portoghese con il codice sorgente (ref task-220)
  - 15 file modificati

- `3332987` - Correggere incoerenze della documentazione cinese tradizionale (Hong Kong) con il codice sorgente (ref task-218)
  - 14 file modificati

- `af9f715` - Correggere incoerenze della documentazione polacca con il codice sorgente (ref task-217)
  - 15 file modificati

- `2e2b18b` - Correggere incoerenze della documentazione coreana con il codice sorgente (ref task-216)
  - 16 file modificati

- `626ebc9` - Correggere incoerenze della documentazione giapponese con il codice sorgente (ref task-215)
  - 19 file modificati

- `48d061b` - Correggere incoerenze della documentazione italiana con il codice sorgente (ref task-214)
  - 14 file modificati

#### Framework di collaborazione
- `6683bee` - Registrare il team Marvis AI, aggiornare lo stato delle attività
  - 3 file modificati

- `03fc905` - Archiviare task-210~220
  - 5 file modificati

### 2026-05-20

#### Nuove funzionalità
- `65176d4` - Aggiungere supporto completo alla localizzazione portoghese (pt-PT + pt-BR) (ref task-208)
  - 41 file modificati

#### Correzioni di coerenza della documentazione
- `af4dffd` - Correggere tutte le incoerenze della documentazione zh-CN con il codice sorgente (ref task-209)
  - 11 file modificati

- `144b945` - Correggere incoerenze della documentazione inglese (en) e ceca (cs-CZ) con il codice sorgente (ref task-219, task-210)
  - 22 file modificati

- `08bec55` - Correggere incoerenze della documentazione tedesca (de-DE) con il codice sorgente (ref task-211)
  - 14 file modificati

- `7ff28de` - Correggere incoerenze della documentazione spagnola (es-ES) con il codice sorgente (ref task-212)
  - 14 file modificati

- `15e2133` - Correggere incoerenze della documentazione francese (fr-FR) con il codice sorgente (ref task-213)
  - 13 file modificati

#### Correzioni di bug
- `7dac388` - Correggere la lista delle attività di progetto non visualizzabile (ref task-207)
  - 6 file modificati

#### Framework di collaborazione
- `7890223` - Archiviare task-201~209, pubblicare attività di correzione coerenza documentazione task-210~220
  - 5 file modificati

### 2026-05-19

#### Nuove funzionalità
- `cd72846` - Implementare alternativa sicura per il bypass della scansione di sicurezza PluginLoader (ref task-203)
  - 13 file modificati

- `fc0c00c` - Miglioramenti Speedy.Manager - Crea/Importa/Esporta/Gerarchia TreeView/Finestra di avanzamento (ref task-206)
  - 9 file modificati

#### Correzioni di bug
- `ec07118` - Correggere il problema di ITypeRegistry/IObjectFactory non registrati prima del caricamento dei plugin (ref task-205)
  - 8 file modificati

- `9e749db` - Correggere l'errore Creator ID is required durante la creazione del progetto (ref task-204)
  - 4 file modificati

#### Infrastruttura
- `43dc092` - Migrazione CLDR - aggiunta di CldrDataProvider, rimozione di .github
  - 1 file modificati

- `c09ec1f` - Aggiungere cldr/ a .gitignore
  - 1 file modificati

- `221f818` - Sincronizzazione GitHub passata a schema mirror push Gitee, workflow mantenuto solo come backup manuale
  - 1 file modificati

- `08cdf1a` - Correggere workflow di sincronizzazione GitHub - aggiunta logica di retry e salto senza modifiche
  - 1 file modificati

- `fb4e77d` - Aggiornamento di SiliconLife.Speedy.Manager.csproj
  - 1 file modificati
...
#### Refactoring
- `e720d06` - Refactoring completo di Speedy.Manager da WinForms ad Avalonia (ref task-202)
  - 17 file modificati

#### Correzioni di bug
- `08894a9` - Correggere errore di visualizzazione del livello delle voci di riepilogo della timeline di memoria (ref task-201)
  - 3 file modificati

#### Framework di collaborazione
- `2871afb` - Archiviare tutte le attività, svuotare tasks.json
  - 2 file modificati

### 2026-05-17

#### Nuove funzionalità
- `d6eb994` - Aggiungere punto di creazione progetto e selezione modello workflow alla pagina elenco progetti (ref task-203)
  - 14 file modificati

- `0872134` - Orchestrazione guidata dal curatore ThinkOnProject per progetti senza modello (ref task-202)
  - 6 file modificati

- `cb3188e` - Visualizzazione @menzione nella chat di gruppo (ref task-208)
  - 4 file modificati

- `f9968e5` - Dichiarazione di capacità ToolCall del client IA e degradazione elegante (ref task-205)
  - 4 file modificati

- `0d2b843` - Logica decisionale chat di gruppo ShouldReplyInGroupChat (ref task-201)
  - 6 file modificati

- `277a2b1` - Completamento rete di conoscenza - query avanzate e attraversamento grafi (ref task-207)
  - 9 file modificati

#### Correzioni di bug
- `6d0b66e` - Correggere TypeError di appendMessage durante l'invio di messaggi nella chat di gruppo (ref task-209)
  - 5 file modificati

- `b15167c` - Invio aggiuntivo della registrazione route list-workflow-templates omessa in task-203 (ref task-203)
  - 1 file modificati

- `dc549a2` - Correggere workflow di sincronizzazione Gitee - aggiunta nome utente all'URL del token
  - 1 file modificati

#### Infrastruttura
- `e5fa3ad` - Disattivare sincronizzazione automatica GitHub schedule, in attesa di soluzione ufficiale Gitee
  - 1 file modificati

#### Framework di collaborazione
- `4a58c82` - Aggiungere rapporto di analisi delle capacità di sistema + proposta di design ThinkOnProject
  - 5 file modificati

- `8ab29e6` - Archiviare rapporto di analisi di completezza delle capacità di sistema in .ai-collab/docs
  - 2 file modificati

- `b412d9c` - Archiviare vecchie attività, ripubblicare task-201~208 basato su analisi completa
  - 2 file modificati

- `437884a` - Aggiornamento metadati di collaborazione - task-202/203/204 completate (ref task-202, task-203, task-204)
  - 2 file modificati

- `bf78d79` - Aggiornamento metadati di collaborazione - task-201/205/208 completate
  - 2 file modificati

- `de6ee0e` - Registrazione fine sessione catpaw-20260517-2215
  - 5 file modificati
...
- `476d839` - Aggiunte attività di rilascio alpha-0.2
  - Create task-114 (redazione CHANGELOG) e task-115 (aggiornamento numero di versione)
  - 1 file modificato

### 2026-05-15

#### Infrastruttura
- `672627b` - Aggiunto workflow di sincronizzazione Gitee (con configurazione permessi)
  - Aggiornati permessi del workflow sync-from-gitee.yml
  - 1 file modificato, 7 inserimenti(+), 4 cancellazioni(-)

- `3cd5256` - Aggiunta sincronizzazione automatica Gitee tramite GitHub Actions
  - Aggiunto workflow sync-from-gitee.yml
  - 1 file modificato, 50 inserimenti(+)

#### Aggiornamenti della documentazione
- `aa1d2ad` - Aggiornati README/architettura/primi-passi in tutte le 11 lingue, riflettendo il supporto multipiattaforma di SiliconLife.Fast (ref task-112, task-113)
  - Corretta la documentazione che descriveva SiliconLife.Fast come solo Windows, riflettendo il supporto multipiattaforma effettivo (Windows / macOS / Linux)
  - Aggiornati README.md, architecture.md, getting-started.md in 11 lingue
  - Aggiunto supporto proprietà hint a SelectComponent
  - ConfigView ora passa il parametro hint ai menu a tendina di enumerazione
  - Aggiunta chiave SelectSearchHint alle localizzazioni di 11 lingue
  - 53 file modificati, 690 inserimenti(+), 194 cancellazioni(-)

#### Sistema di attività
- `3329f3d` - Aggiunto meccanismo di ispezione del sistema di attività + attività di correzione bug di localizzazione
  - Creata task-113: correggere problema di localizzazione nella pagina informazioni
  - Aggiornata task-112: aggiornare documentazione versione Fast per supporto Linux
  - Archiviate attività completate (11) in .ai-collab/archive/
  - Meccanismo di ispezione configurato: ispezione rapida (ogni 30 min) + ispezione completa (giornaliera 06:00)
  - 2 file modificati, 148 inserimenti(+), 171 cancellazioni(-)

#### Framework di collaborazione
- `6038e22` - coze-agent registrato nel registro .ai-collab
  - Aggiunte informazioni di registrazione AI residente della piattaforma Coze
  - 1 file modificato

### 2026-05-14

#### Framework di collaborazione AI
- `7344fbb` - Modalità handoff rimossa, passaggio all'approccio basato su lista di attività (v2.0)
  - Ristrutturata directory .ai-collab dalla modalità handoff all'approccio basato su lista di attività
  - Aggiunto file core della lista di attività tasks.json
  - Aggiunto registro delle operazioni activity.log
  - Aggiunte directory changes/ e sessions/

- `589a48e` - Aggiunti record di sessione .ai-collab
  - Aggiunti record di stato della sessione di collaborazione AI

- `5481bcf` - Qoder AI IDE registrato nel registro di collaborazione
  - Aggiunte informazioni di registrazione dell'assistente di codifica Qoder AI

- `e2d7b61` - relatedCommit e changes commitHash di tasks.json completati
  - Associazioni dei metadati delle attività completate

- `a087f0c` - Tutte le attività task-101~110 accettate
  - Confermato che tutte le 10 correzioni di attività sono completate

#### Correzione di bug
- `fac9435` - Completate tutte le correzioni e implementazioni di task-101~110
  - Corretto testo suggerimento mancante nel componente di selezione ricerca
  - Corretti problemi di localizzazione nella pagina informazioni
  - Corretto errore JS di ricerca nel sistema di aiuto
  - 39 file modificati, 684 inserimenti(+), 121 cancellazioni(-)

- `c46dfbc` - Completate tutte le attività in sospeso (task-001~006)
  - Completate 6 attività in sospeso iniziali

- `ec176b2` - Lista di attività sovrascritta - revisione del codice ha trovato 10 nuovi bug
  - Create task-101~110 (10 nuove attività)

#### Refactoring
- `ab15915` - Intestazioni copyright unificate + HelpController BOM e HelpView ricerca JS corretti
  - Intestazioni copyright Apache 2.0 unificate in tutti i file sorgente C#
  - Corretto problema di codifica BOM di HelpController
  - Corretto errore JavaScript di ricerca di HelpView

#### Nuove funzionalità
- `18a6f5d` - Server di capacità browser MCP creato (ref task-111)
  - Aggiunto progetto SiliconLife.McpServer
  - Implementato server MCP di automazione browser Playwright

- `9eb251a` - Modulo SiliconLife.McpServer rimosso (ref task-111)
  - Server MCP autonomo rimosso, funzionalità integrata nel progetto principale

### 2026-05-13

#### Localizzazione
- `7a62590` - Aggiunto supporto localizzazione polacca
  - Aggiunta implementazione localizzazione polacca pl-PL (PlPL.cs, 1089 righe)
  - Aggiunta localizzazione documentazione di aiuto polacca (HelpLocalizationPlPL.cs, 3972 righe)
  - Aggiunto supporto calendario storico cinese polacco (ChineseHistoricalPlPL.cs, 600 righe)
  - Aggiunta localizzazione tray polacca (TrayPlPL.cs, 135 righe)
  - Aggiunto set completo di documentazione polacca (15 documenti)
  - Enumerazione Language estesa con polacco
  - 35 file modificati, 14379 inserimenti(+), 11 cancellazioni(-)

- `51f9c8e` - Aggiornati riferimenti Ark AI e miglioramenti terminologici nella documentazione
  - Terminologia del client AI aggiornata nella documentazione multilingue

- `7587c12` - Aggiunte voci del registro delle modifiche per tutte le lingue
  - Aggiornamenti del registro delle modifiche sincronizzati in tutte le versioni linguistiche

#### Migrazione del sistema finestre
- `b49a07d` - Migrazione alla modalità residente finestra Avalonia
  - Rimossa dipendenza Windows Forms, migrazione completa al framework Avalonia UI
  - Finestra di stato visualizzata correttamente su Linux (verificata tramite desktop remoto)
  - Aggiunti controlli finestra: menu contestuale, doppio clic per aprire il Web, pulsante di chiusura
  - Aggiunto framework di collaborazione multi-AI (.ai-collab/)
  - Corretta inizializzazione dell'icona tray (degradazione elegante)
  - Aggiunti App.axaml e App.cs come punti di ingresso dell'applicazione Avalonia
  - 13 file modificati, 1442 inserimenti(+), 541 cancellazioni(-)

- `d335aaf` - Finestra sempre visibile su piattaforma Linux + dialogo di conferma chiusura
  - Linux mostra automaticamente la finestra di stato (nessuna icona tray)
  - Linux mostra dialogo di conferma alla chiusura della finestra
  - Windows/macOS mantengono il comportamento tray originale
  - Supportato parametro --no-tray per disabilitare forzatamente il tray
  - Aggiunto metodo ShowMessageBoxAsync per dialoghi di conferma
  - 3 file modificati, 206 inserimenti(+), 29 cancellazioni(-)

#### Refactoring del sistema tray
- `841d384` - Sistema tray refattorizzato e framework di collaborazione AI inizializzato
  - TrayLocalizationBase snellito, proprietà inutilizzate rimosse
  - Aggiunto elemento di localizzazione ShowStatus
  - App.cs: clic sull'icona tray mostra finestra di stato, aggiunti elementi di menu localizzati
  - Program.cs: inizializzazione icona tray spostata in StartAsync
  - TrayStatusWindow si nasconde invece di chiudersi alla chiusura
  - Registrati trae-glm5 e catpaw nel framework .ai-collab
  - Aggiornato .gitignore per assicurare che tutti i file .ai-collab siano tracciati
  - 22 file modificati, 178 inserimenti(+), 1226 cancellazioni(-)

#### Documentazione
- `43653bc` - Descrizione del repository e registro AI aggiornati
  - README del progetto e informazioni di registrazione .ai-collab aggiornati
...
#### Localizzazione degli strumenti
- `192fc6e` - Aggiunta dei nomi degli strumenti mancanti per 5 strumenti
  - 6 file modificati, 30 righe aggiunte

#### Aggiornamento della documentazione
- `882c08f` - Aggiornamento di tutti i file changelog, aggiunta della cronologia Git completa e rimozione dei numeri di versione falsi
  - 45 file modificati, 8815 righe aggiunte, 1611 righe eliminate

#### Miglioramento della pagina chat
- `65c157b` - Aggiunta di indicatori di caricamento per le pagine di chat e selezione automatica della sessione del curator
  - 10 file modificati, 211 righe aggiunte, 7 righe eliminate

#### Funzionalità cronologia chat
- `e483348` - Implementazione della funzionalità di visualizzazione della cronologia chat dei Silicon Beings
  - Nuovo ChatHistoryController
  - Creazione di ChatHistoryViewModel
  - Implementazione delle pagine ChatHistoryListView e ChatHistoryDetailView
  - Aggiunta delle chiavi di localizzazione della cronologia chat (5 lingue)
  - 12 file modificati, 1178 righe aggiunte

#### Miglioramento del controllo di flusso IA
- `30a2d4e` - Miglioramento dell'annullamento del flusso IA, dell'integrazione IM e dell'inizializzazione del core host
  - 11 file modificati, 387 righe aggiunte, 12 righe eliminate

#### Coda di messaggi chat
- `db48c51` - Aggiunta della coda di messaggi di chat, metadati di file e supporto di annullamento dello stream
  - 4 file modificati, 357 righe aggiunte

#### Supporto upload file
- `28fb344` - Implementazione del dialogo di origine file e supporto upload file
  - 3 file modificati, 1100 righe aggiunte, 2 righe eliminate
- `1d3e2cc` - Aggiunta delle stringhe di localizzazione del dialogo di origine file (6 lingue)
  - 6 file modificati, 30 righe aggiunte
