...
/// <summary>
/// LiteDB-based logger provider implementing ILoggerProvider and ILogReader
/// </summary>
public sealed class LiteDBLoggerProvider : ILoggerProvider, ILogReader
{
    ...
    public LiteDBLoggerProvider()
    {
        _storage = new LiteDBTimeStorage();
    }
