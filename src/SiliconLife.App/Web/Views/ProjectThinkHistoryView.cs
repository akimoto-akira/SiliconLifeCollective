...
public class ProjectThinkHistoryView : ViewBase
{
    public override string Render(object model)
    {
        var vm = model as ProjectThinkHistoryViewModel;
        if (vm == null) return string.Empty;
        var body = RenderBody(vm);
        return RenderPage(vm.Skin, vm.Localization.ProjectThinkHistoryTitle, "project-think-history", vm.Localization, body, GetScripts(vm), GetStyles(), "projects");
    }

    private static H RenderBody(ProjectThinkHistoryViewModel vm)
    {
        return H.Div(
            H.Div(
                H.A(vm.Localization.ProjectThinkBackToProjects).Href("/project").Class("back-link"),
                H.H1(vm.Localization.ProjectThinkHistoryHeader),
                H.P(string.Format(vm.Localization.ProjectThinkProjectName, vm.ProjectName)).Class("page-subtitle")
            ).Class("page-header"),
    ...
    private static JsSyntax GetScripts(ProjectThinkHistoryViewModel vm)
    {
        var forEachBody = Js.Block()
            ...
            .Add(() => Js.Assign(() => Js.Id(() => "item").Prop(() => "onclick"), () => Js.Arrow(
                ...
                () => Js.Assign(
                    ...
                    () => Js.Str(() => "/project-think-session/")
                        .Op(() => "+", () => Js.Id(() => "e").Prop(() => "sessionId"))
                        .Op(() => "+", () => Js.Str(() => "?projectId="))
                        .Op(() => "+", () => Js.Id(() => "projectId"))
                )
            )))
            .Add(() => Js.Assign(() => Js.Id(() => "item").Prop(() => "innerHTML"), () => BuildItemHtml(vm)))
        ...
        var loadBody = Js.Block()
            .Add(() => Js.Const(() => "emptyMessage", () => Js.Str(() => vm.Localization.ProjectThinkNoRecords)))
            .Add(() => Js.Id(() => "fetch")
                .Invoke(() => Js.Str(() => "/api/projects/").Op(() => "+", () => Js.Id(() => "projectId")).Op(() => "+", () => Js.Str(() => "/think-sessions/list")))
                .Call(() => "then", () => Js.Arrow(() => new List<string> { "r" }, () => Js.Id(() => "r").Call(() => "json")))
                .Call(() => "then", () => Js.Arrow(() => new List<string> { "data" }, () => thenBody)).Stmt());

        return Js.Block()
            .Add(() => Js.Const(() => "projectId", () => Js.Id(() => "window").Prop(() => "location").Prop(() => "pathname").Call(() => "split", () => Js.Str(() => "/")).Index(() => Js.Num(() => "2"))))
            .Add(() => Js.Func(() => "loadSessions", () => new List<string>(), () => loadBody))
            .Add(() => Js.Assign(() => Js.Id(() => "window").Prop(() => "onload"), () => Js.Arrow(() => new List<string>(), () => Js.Id(() => "loadSessions").Invoke())));
    }

    private static JsSyntax BuildItemHtml(ProjectThinkHistoryViewModel vm)
    {
        return Js.Str(() => "<div class='execution-header'><span class='execution-state ")
            ...
            .Op(() => "+", () => (JsSyntax)Js.Str(() => "</div>"))
            .Op(() => "+", () => Js.Str(() => "<div class='execution-info'><span class='execution-info-label'>Created:</span>"))
            .Op(() => "+", () => (JsSyntax)Js.Id(() => "e").Prop(() => "createdAt"))
            .Op(() => "+", () => (JsSyntax)Js.Str(() => "</div>"))
            .Op(() => "+", () => Js.Ternary(
