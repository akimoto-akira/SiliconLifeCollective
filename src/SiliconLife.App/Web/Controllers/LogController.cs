...
public class LogController : Controller
{
    ...
    public LogController()
    {
        ...
        // _beingManager access through ServiceLocator.Instance.BeingManager when needed
    }
    ...
    {
        // Being list retrieval disabled for shared module
    ...
    {
            var config = Collective.Config.Instance.Data as AppConfigData;
