...
using SiliconLife.App.Web.Controllers;
...
public class Router
{
    ...
    public void RegisterControllers()
    {
        ...
        RegisterController(() => new ChatHistoryController(), "/chat-history");
        RegisterController(() => new ChatHistoryController(), "/chat-history-detail");
        RegisterController(() => new ChatHistoryController(), "/api/chat-history/conversations");
        RegisterController(() => new ChatHistoryController(), "/api/chat-history/messages");
        RegisterController(() => new ChatHistoryController(), "/group-chat-history-detail");
        ...
        RegisterController(() => new ConfigController(), "/config/browse", "GET");
        ...
        RegisterController(() => new ProjectController(), "/api/projects/{id}/archive", "POST");
        ...
        RegisterController(() => new ProjectController(), "/api/projects/{id}/work-notes/list");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/work-notes/read");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/work-notes/create", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/work-notes/update", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/work-notes/delete", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/list");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/create", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/update", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/delete", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/assign", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/remove-assignee", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/complete", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/fail", "POST");
        RegisterController(() => new ProjectController(), "/api/projects/{id}/tasks/cancel", "POST");
