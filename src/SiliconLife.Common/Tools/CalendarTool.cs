...
/// </summary>
[ToolAction("now", "format", "add_days", "diff", "list_calendars", "get_components", "get_now_components", "convert")]
...
public class CalendarTool : ITool
{
    ...
    {
        var calendarIds = CalendarBase.BuildCalendarRegistry().Keys.ToArray<object>();
    ...
    {
        DefaultLocalizationBase loc = CalendarBase.GetLocalization();
