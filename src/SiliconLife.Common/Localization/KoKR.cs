...
사용 방법: chat 도구를 호출하고 action=""mark_read"", target_id=상대방 GUID 를 설정하세요. message 매개변수는 필요하지 않습니다.";
    ...
    public override string MemoryTimelineEmptyState => "메모리 데이터 없음";
    public override string MemoryYearSummaryLabel => "연간 요약";
    public override string MemoryMonthSummaryLabel => "월간 요약";
    public override string MemoryDaySummaryLabel => "일간 요약";
    public override string MemoryHourSummaryLabel => "시간 요약";
    public override string MemoryMinuteSummaryLabel => "분 요약";
    public override string MemorySummaryBadge => "압축 요약";
    public override string MemoryTimelineYearFormat => "{0}년 ({1}개)";
    public override string MemoryTimelineMonthFormat => "{0}년 {1}월 ({2}개)";
    public override string MemoryTimelineDayFormat => "{0}-{1}-{2} ({3}개)";
    public override string MemoryTimelineHourFormat => "{0}:00 ({1}개)";
    public override string MemoryTimelineMinuteFormat => "{0}:{1} ({2}개)";
    public override string MemoryRelatedBeingsLabel => "👥 관련: {0} 에이전트";
    ...
    public override string WorkflowDetailPageHeader => "워크플로우 상세";
    public override string WorkflowRoleAssignmentsHeader => "역할 할당";
    public override string WorkflowUnassignedBeingsHeader => "미할당 실리콘 비잉";
    public override string WorkflowNoUnassignedBeings => "모든 실리콘 비잉에 역할이 할당되었습니다";
    public override string WorkflowStateTransitionsHeader => "작업 상태 전이";
    public override string WorkflowNoTemplateMessage => "이 프로젝트에 워크플로우 템플릿이 연결되지 않았습니다";
    public override string WorkflowNoRoleDefinitions => "이 워크플로우 템플릿에 역할 정의가 없습니다";
    public override string WorkflowNoTransitions => "이 워크플로우 템플릿에 상태 전이가 정의되지 않았습니다";
    public override string WorkflowRoleAssignedCountLabel => "할당됨";
    public override string WorkflowRoleRequiredCountLabel => "필요";
    public override string WorkflowTransitionFromLabel => "에서";
    public override string WorkflowTransitionToLabel => "으로";
    public override string WorkflowAssignRoleButton => "역할 할당";
    public override string WorkflowRemoveFromRoleButton => "제거";
    public override string WorkflowTerminalStateLabel => "종료 상태";
    public override string WorkflowInitialStateLabel => "초기 상태";
...
public override string AboutFailedPluginListLabel => "로드 실패한 플러그인";
public override string GetSocialMediaName(string platform) => platform switch
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ...
        ["HerdsmanClient"] = "Herdsman 클라이언트",
        ["HerdsmanEndpoint"] = "Herdsman 엔드포인트",
        ["HerdsmanModel"] = "모델",
        ["HerdsmanContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["LongCatClient"] = "LongCat 클라이언트",
        ["LongCatApiKey"] = "API 키",
        ["LongCatEndpoint"] = "LongCat 엔드포인트",
        ["LongCatModel"] = "모델",
        ["LongCatContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0 (1M 컨텍스트, 128K 출력, Agentic) - 권장",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat (레거시, 128K)",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat (레거시, 128K)",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat (레거시, 128K)",
        ["QiniuAIClient"] = "Qiniu AI 클라이언트",
        ["QiniuAIApiKey"] = "API 키",
        ["QiniuAIEndpoint"] = "Qiniu AI 엔드포인트",
        ["QiniuAIModel"] = "모델",
        ["QiniuAIContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["DeepSeekClient"] = "DeepSeek 클라이언트",
        ["DeepSeekApiKey"] = "API 키",
        ["DeepSeekModel"] = "모델",
        ["DeepSeekEndpoint"] = "엔드포인트",
        ["DeepSeekContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["ZhipuClient"] = "Zhipu 클라이언트",
        ["ZhipuApiKey"] = "API 키",
        ["ZhipuModel"] = "모델",
        ["ZhipuEndpoint"] = "엔드포인트",
        ["ZhipuContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["MoonshotClient"] = "Moonshot 클라이언트",
        ["MoonshotApiKey"] = "API 키",
        ["MoonshotModel"] = "모델",
        ["MoonshotEndpoint"] = "엔드포인트",
        ["MoonshotContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["SiliconFlowClient"] = "SiliconFlow 클라이언트",
        ["SiliconFlowApiKey"] = "API 키",
        ["SiliconFlowModel"] = "모델",
        ["SiliconFlowEndpoint"] = "엔드포인트",
        ["SiliconFlowContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["MiniMaxClient"] = "MiniMax 클라이언트",
        ["MiniMaxApiKey"] = "API 키",
        ["MiniMaxModel"] = "모델",
        ["MiniMaxEndpoint"] = "엔드포인트",
        ["MiniMaxContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["ErnieClient"] = "Ernie 클라이언트",
        ["ErnieApiKey"] = "API 키",
        ["ErnieModel"] = "모델",
        ["ErnieEndpoint"] = "엔드포인트",
        ["ErnieContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ["HunyuanClient"] = "Hunyuan 클라이언트",
        ["HunyuanApiKey"] = "API 키",
        ["HunyuanModel"] = "모델",
        ["HunyuanEndpoint"] = "엔드포인트",
        ["HunyuanContextWindowTokens"] = "컨텍스트 윈도우 Tokens",
        ...
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, 2026-08-31 종료 예정)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro (번역, 8K)",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus (번역, 8K)",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite (번역, 8K)",
        ["HunyuanModel_hunyuan-role-latest"] = "Hy Role Latest (롤플레이, 32K)",
        ["HunyuanModel_hy-role"] = "Hy Role (롤플레이, 32K)",
        ...
        ["SkillEnabled"] = "스킬 활성화",
        ["MaxContextMessages"] = "최대 컨텍스트 메시지 수",
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Ollama 모델의 컨텍스트 윈도우 Token 용량, 비워두면 자동 감지",
        ...
        ["HerdsmanEndpoint"] = "Herdsman 추론 엔진 API 엔드포인트 URL",
        ["HerdsmanModel"] = "Herdsman 추론 엔진에서 사용할 모델",
        ["HerdsmanContextWindowTokens"] = "Herdsman 추론 엔진 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["LongCatApiKey"] = "메이퇀 LongCat 대모델 API 키",
        ["LongCatEndpoint"] = "메이퇀 LongCat 대모델 API 엔드포인트 URL",
        ["LongCatModel"] = "메이퇀 LongCat 대모델에서 사용할 모델",
        ["LongCatContextWindowTokens"] = "LongCat 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["QiniuAIApiKey"] = "치우니우 클라우드 AI 대모델 추론 서비스 API 키",
        ["QiniuAIEndpoint"] = "치우니우 클라우드 AI 대모델 추론 서비스 API 엔드포인트 URL",
        ["QiniuAIModel"] = "치우니우 클라우드 AI 대모델 추론 서비스에서 사용할 모델",
        ["QiniuAIContextWindowTokens"] = "Qiniu AI 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["DeepSeekApiKey"] = "DeepSeek API 키",
        ["DeepSeekModel"] = "DeepSeek 사용할 모델",
        ["DeepSeekEndpoint"] = "DeepSeek API 엔드포인트 URL",
        ["DeepSeekContextWindowTokens"] = "DeepSeek 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["ZhipuApiKey"] = "Zhipu GLM API 키",
        ["ZhipuModel"] = "Zhipu GLM 사용할 모델",
        ["ZhipuEndpoint"] = "Zhipu GLM API 엔드포인트 URL",
        ["ZhipuContextWindowTokens"] = "Zhipu 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["MoonshotApiKey"] = "Moonshot Kimi API 키",
        ["MoonshotModel"] = "Moonshot Kimi 사용할 모델",
        ["MoonshotEndpoint"] = "Moonshot Kimi API 엔드포인트 URL",
        ["MoonshotContextWindowTokens"] = "Moonshot 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["SiliconFlowApiKey"] = "SiliconFlow API 키",
        ["SiliconFlowModel"] = "SiliconFlow 사용할 모델",
        ["SiliconFlowEndpoint"] = "SiliconFlow API 엔드포인트 URL",
        ["SiliconFlowContextWindowTokens"] = "SiliconFlow 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["MiniMaxApiKey"] = "MiniMax API 키",
        ["MiniMaxModel"] = "MiniMax 사용할 모델",
        ["MiniMaxEndpoint"] = "MiniMax API 엔드포인트 URL",
        ["MiniMaxContextWindowTokens"] = "MiniMax 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["ErnieApiKey"] = "Baidu Ernie API 키",
        ["ErnieModel"] = "Baidu Ernie 사용할 모델",
        ["ErnieEndpoint"] = "Baidu Ernie API 엔드포인트 URL",
        ["ErnieContextWindowTokens"] = "Ernie 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["HunyuanApiKey"] = "Tencent Hunyuan API 키",
        ["HunyuanModel"] = "Tencent Hunyuan 사용할 모델",
        ["HunyuanEndpoint"] = "Tencent Hunyuan API 엔드포인트 URL",
        ["HunyuanContextWindowTokens"] = "Hunyuan 모델의 컨텍스트 윈도우 Token 용량, 비워두면 기본 메시지 제한으로 대체",
        ["WebPort"] = "Web 서버 포트",
        ["WebSkin"] = "Web 스킨 이름",
        ["UserNickname"] = "사용자 닉네임",
        ...
        ["MaxContextMessages"] = "AI 요청당 컨텍스트에 로드되는 최근 채팅 메시지 수의 상한(모델이 컨텍스트 윈도우 크기를 보고하지 않을 때 폴백 창으로 사용)",
    ...
    {
        BeingActivity.Idle => "대기 중",
        BeingActivity.SingleChat => "1:1 채팅 중",
        BeingActivity.GroupChat => "그룹 채팅 중",
        BeingActivity.Task => "작업 실행 중",
        BeingActivity.Timer => "타이머 실행 중",
        BeingActivity.Broadcast => "브로드캐스트 처리 중",
        BeingActivity.Project => "프로젝트 작업 중",
    ...
    public override string ProjectCtx_ProjectInfoHeader => "프로젝트 소속";
    public override string ProjectCtx_ProjectInfoRoleLabel => "역할";
    public override string ProjectCtx_ProjectInfoGoalLabel => "목표";
    ...
    public override string ProjectCtx_RoleNeedsAttention => "⚠ {0}개 역할이 인력 부족입니다. 실리콘 빙을 생성하고 역할에 할당해야 합니다";
    public override string ProjectCtx_StaffingActionPlanHeader => "인력 배치 행동 계획";
    public override string ProjectCtx_TotalBeingsNeeded => "생성해야 할 실리콘 빙 총수: {0}";
    public override string ProjectCtx_StaffingRoleBreakdownHeader => "역할별 인력 부족 상세";
    public override string ProjectCtx_RoleShortageDetail => "{0}: 필요 {1}, 현재 {2} → {3}명 부족";
    public override string ProjectCtx_StaffingActionStepsHeader => "권장 작업 단계";
    public override string ProjectCtx_StaffingStepCreateBeings => "1. silicon_manager의 create_being으로 {0}개의 실리콘 빙을 생성 (각 역할에 최소 1개)";
    public override string ProjectCtx_StaffingStepAssignToProject => "2. project의 assign으로 새로 생성된 실리콘 빙을 프로젝트에 추가";
    public override string ProjectCtx_StaffingStepAssignToRoles => "3. project의 assign_role로 각 실리콘 빙을 해당 역할에 할당";
    public override string ProjectCtx_EmptyRolePoolAction => "⚠ 역할 풀이 비어 있습니다! 워크플로우가 {0}개 역할을 정의하고 있습니다. 실리콘 빙을 생성하고 각 역할에 할당하세요";
    ...
    public override string ProjectCtx_AvailableBeingsHeader => "사용 가능한 실리콘 비잉 (이 프로젝트에 아직 할당되지 않음)";
    public override string ProjectCtx_AvailableBeingsHint => "팁: 새로 만들기 전에 기존 비잉을 역할에 할당하는 것을 우선하세요. project assign 및 project assign_role을 사용하세요.";
    ...
    public override string ProjectThinkCycleLabel => "사이클";
    public override string ProjectThinkRoundN => "제{0}라운드";
}
