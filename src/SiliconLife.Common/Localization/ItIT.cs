...
_ => permissionType.ToString()
    ...
    public override string PageTitleSkills => "Gestione competenze";
    public override string SkillsPageHeader => "Competenze";
    public override string SkillsPageSubtitle => "Competenze = orchestrazione riutilizzabile di strumenti + modelli di prompt (Markdown; metadati nel front matter YAML)";
    public override string SkillsStatFormat => "{0} competenze · personalizzate {1}/{2}";
    public override string SkillsEmptyState => "Nessuna competenza";
    public override string SkillsBackToBeings => "← Torna ai beings";
    public override string SkillBtnNew => "Nuova competenza";
    public override string SkillBtnImportMd => "Importa Markdown";
    public override string SkillBtnImportJson => "Importa JSON";
    public override string SkillBtnRefresh => "Aggiorna";
    public override string SkillBtnEdit => "Modifica";
    ...
    public override string SkillBtnDelete => "Elimina";
    public override string SkillCurrentEditingFormat => "In modifica: {0}";
    public override string SkillNewSkillLabel => "Nuova competenza (non salvata)";
    public override string SkillConfirmDeleteFormat => "Eliminare la competenza {0}?";
    public override string SkillPromptImportMd => "Incolla il Markdown della competenza (front matter YAML + corpo; i metadati mancanti verranno completati automaticamente)";
    public override string SkillPromptImportJson => "Incolla il JSON della SkillDefinition";
    public override string SkillPromptTestParams => "Inserisci il JSON dei parametri di test (es. {\"source\": \"...\"}), lascia vuoto per nessuno";
    public override string SkillTestResultPrefix => "Risultato: ";
    public override string SkillLoadFailedFormat => "Caricamento non riuscito: {0}";
    public override string SkillRequestFailed => "Richiesta non riuscita";
...
public override string AboutFailedPluginListLabel => "Plugin con errore di caricamento";
public override string GetSocialMediaName(string platform) => platform switch
    ...
    private static readonly Dictionary<string, string> ConfigGroupNames = new()
    {
        ...
        ["Skill"] = "Configurazione competenze"
    };
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0 (1M contesto, 128K output, Agentic) - Consigliato",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat (Precedente, 128K)",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat (Precedente, 128K)",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat (Precedente, 128K)",
        ["QiniuAIClient"] = "Client Qiniu AI",
        ["QiniuAIApiKey"] = "Chiave API",
        ["QiniuAIEndpoint"] = "Endpoint Qiniu AI",
        ["QiniuAIModel"] = "Modello",
        ["QiniuAIContextWindowTokens"] = "Token finestra di contesto",
        ["DeepSeekClient"] = "Client DeepSeek",
        ["DeepSeekApiKey"] = "Chiave API",
        ["DeepSeekModel"] = "Modello",
        ["DeepSeekEndpoint"] = "Endpoint",
        ["DeepSeekContextWindowTokens"] = "Token finestra di contesto",
        ["ZhipuClient"] = "Client Zhipu",
        ["ZhipuApiKey"] = "Chiave API",
        ["ZhipuModel"] = "Modello",
        ["ZhipuEndpoint"] = "Endpoint",
        ["ZhipuContextWindowTokens"] = "Token finestra di contesto",
        ["MoonshotClient"] = "Client Moonshot",
        ["MoonshotApiKey"] = "Chiave API",
        ["MoonshotModel"] = "Modello",
        ["MoonshotEndpoint"] = "Endpoint",
        ["MoonshotContextWindowTokens"] = "Token finestra di contesto",
        ["SiliconFlowClient"] = "Client SiliconFlow",
        ["SiliconFlowApiKey"] = "Chiave API",
        ["SiliconFlowModel"] = "Modello",
        ["SiliconFlowEndpoint"] = "Endpoint",
        ["SiliconFlowContextWindowTokens"] = "Token finestra di contesto",
        ["MiniMaxClient"] = "Client MiniMax",
        ["MiniMaxApiKey"] = "Chiave API",
        ["MiniMaxModel"] = "Modello",
        ["MiniMaxEndpoint"] = "Endpoint",
        ["MiniMaxContextWindowTokens"] = "Token finestra di contesto",
        ["ErnieClient"] = "Client Ernie",
        ["ErnieApiKey"] = "Chiave API",
        ["ErnieModel"] = "Modello",
        ["ErnieEndpoint"] = "Endpoint",
        ["ErnieContextWindowTokens"] = "Token finestra di contesto",
        ["HunyuanClient"] = "Client Hunyuan",
        ["HunyuanApiKey"] = "Chiave API",
        ["HunyuanModel"] = "Modello",
        ["HunyuanEndpoint"] = "Endpoint",
        ["HunyuanContextWindowTokens"] = "Token finestra di contesto",
        ...
        ["ErnieModel_glm-5.2"] = "GLM 5.2 (1M contesto, leader in compiti lunghi)",
        ["ErnieModel_glm-5.1"] = "GLM 5.1 (codifica avanzata, risultati di livello ingegneristico)",
        ["ErnieModel_deepseek-v4-pro"] = "DeepSeek V4 Pro (milione di contesto, leader in Agent/ragionamento)",
        ["ErnieModel_deepseek-v4-flash"] = "DeepSeek V4 Flash (leggero efficiente, milione di contesto)",
        ["ErnieModel_kimi-k2.6"] = "Kimi K2.6 (codice lungo, input testo/immagine)",
        ["ErnieModel_ernie-5.1"] = "ERNIE 5.1 (ultimo Wenxin, agente/ragionamento aggiornato)",
        ["ErnieModel_qianfan-code-latest"] = "qianfan-code-latest (controllato dalla console)",
        ["HunyuanModel_hy3"] = "Hy3 (TokenHub, 256K) - Recommended",
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, ritirato il 31/08/2026)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro (Traduzione, 8K)",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus (Traduzione, 8K)",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite (Traduzione, 8K)",
        ["HunyuanModel_hunyuan-role-latest"] = "Hy Role Latest (Gioco di ruolo, 32K)",
        ["HunyuanModel_hy-role"] = "Hy Role (Gioco di ruolo, 32K)",
        ...
        ["SkillEnabled"] = "Abilita competenze",
        ["MaxContextMessages"] = "Messaggi di contesto massimi",
        ["GlobalMaxToolRound"] = "Round massimi di strumenti globali",
        ["GlobalSkillTimeoutSeconds"] = "Timeout competenze globale (s)",
        ["MaxCustomSkillsPerBeing"] = "Competenze personalizzate massime per essere"
    };
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["QiniuAIApiKey"] = "Chiave API del servizio di inferenza modello grande Qiniu Cloud AI",
        ["QiniuAIEndpoint"] = "URL dell'endpoint API del servizio di inferenza modello grande Qiniu Cloud AI",
        ["QiniuAIModel"] = "Modello da utilizzare per il servizio di inferenza modello grande Qiniu Cloud AI",
        ["QiniuAIContextWindowTokens"] = "Capacità token finestra di contesto per modelli Qiniu AI, lasciare vuoto per tornare al limite messaggi predefinito",
        ["DeepSeekApiKey"] = "Chiave API DeepSeek",
        ["DeepSeekModel"] = "Modello DeepSeek da utilizzare",
        ["DeepSeekEndpoint"] = "URL endpoint API DeepSeek",
        ["DeepSeekContextWindowTokens"] = "Capacità token finestra di contesto per modelli DeepSeek, lasciare vuoto per tornare al limite messaggi predefinito",
        ["ZhipuApiKey"] = "Chiave API Zhipu GLM",
        ["ZhipuModel"] = "Modello Zhipu GLM da utilizzare",
        ["ZhipuEndpoint"] = "URL endpoint API Zhipu GLM",
        ["ZhipuContextWindowTokens"] = "Capacità token finestra di contesto per modelli Zhipu, lasciare vuoto per tornare al limite messaggi predefinito",
        ["MoonshotApiKey"] = "Chiave API Moonshot Kimi",
        ["MoonshotModel"] = "Modello Moonshot Kimi da utilizzare",
        ["MoonshotEndpoint"] = "URL endpoint API Moonshot Kimi",
        ["MoonshotContextWindowTokens"] = "Capacità token finestra di contesto per modelli Moonshot, lasciare vuoto per tornare al limite messaggi predefinito",
        ["SiliconFlowApiKey"] = "Chiave API SiliconFlow",
        ["SiliconFlowModel"] = "Modello SiliconFlow da utilizzare",
        ["SiliconFlowEndpoint"] = "URL endpoint API SiliconFlow",
        ["SiliconFlowContextWindowTokens"] = "Capacità token finestra di contesto per modelli SiliconFlow, lasciare vuoto per tornare al limite messaggi predefinito",
        ["MiniMaxApiKey"] = "Chiave API MiniMax",
        ["MiniMaxModel"] = "Modello MiniMax da utilizzare",
        ["MiniMaxEndpoint"] = "URL endpoint API MiniMax",
        ["MiniMaxContextWindowTokens"] = "Capacità token finestra di contesto per modelli MiniMax, lasciare vuoto per tornare al limite messaggi predefinito",
        ["ErnieApiKey"] = "Chiave API Baidu Ernie",
        ["ErnieModel"] = "Modello Baidu Ernie da utilizzare",
        ["ErnieEndpoint"] = "URL endpoint API Baidu Ernie",
        ["ErnieContextWindowTokens"] = "Capacità token finestra di contesto per modelli Ernie, lasciare vuoto per tornare al limite messaggi predefinito",
        ["HunyuanApiKey"] = "Chiave API Tencent Hunyuan",
        ["HunyuanModel"] = "Modello Tencent Hunyuan da utilizzare",
        ["HunyuanEndpoint"] = "URL endpoint API Tencent Hunyuan",
        ["HunyuanContextWindowTokens"] = "Capacità token finestra di contesto per modelli Hunyuan, lasciare vuoto per tornare al limite messaggi predefinito",
        ...
        ["SkillEnabled"] = "Abilita il sistema di competenze (registrazione delle competenze, smistamento tramite IA e attivatori automatici)",
        ["MaxContextMessages"] = "Numero massimo di messaggi di chat recenti caricati nel contesto per richiesta IA (usato come finestra di ripiego quando il modello non riporta la dimensione della finestra di contesto)",
        ["GlobalMaxToolRound"] = "Limite superiore dei round di chiamate degli strumenti per ogni esecuzione di una competenza",
        ["GlobalSkillTimeoutSeconds"] = "Limite superiore della durata di esecuzione di una competenza in secondi",
        ["MaxCustomSkillsPerBeing"] = "Numero massimo di competenze personalizzate (non incorporate) che ogni essere in silicio può possedere"
    };
