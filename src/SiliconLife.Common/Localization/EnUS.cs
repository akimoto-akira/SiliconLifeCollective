...
Usage: Call the chat tool with action=""mark_read"", target_id=partner's GUID, no message parameter needed.";
    ...
    public override string NavMenuUsage => "Usage";
    ...
    public override string PageTitleUsage => "Token Usage - Silicon Life Collective";
    public override string PageTitleAudit => "Permission Audit - Silicon Life Collective";
    ...
    public override string WorkNotesBackToPrevious => "← Back";
    ...
    public override string WorkflowDetailPageHeader => "Workflow Details";
    public override string WorkflowRoleAssignmentsHeader => "Role Assignments";
    public override string WorkflowUnassignedBeingsHeader => "Unassigned Silicon Beings";
    public override string WorkflowNoUnassignedBeings => "All silicon beings are assigned to roles";
    public override string WorkflowStateTransitionsHeader => "Task State Transitions";
    public override string WorkflowNoTemplateMessage => "No workflow template associated with this project";
    public override string WorkflowNoRoleDefinitions => "This workflow template has no role definitions";
    public override string WorkflowNoTransitions => "This workflow template has no state transitions";
    public override string WorkflowRoleAssignedCountLabel => "Assigned";
    public override string WorkflowRoleRequiredCountLabel => "Required";
    public override string WorkflowTransitionFromLabel => "From";
    public override string WorkflowTransitionToLabel => "To";
    public override string WorkflowAssignRoleButton => "Assign Role";
    public override string WorkflowRemoveFromRoleButton => "Remove";
    ...
    public override string TaskViewExecutionHistory => "View execution history";
    ...
    public override string TaskExecutionHistoryTitle => "Task Execution History";
    public override string TaskExecutionHistoryHeader => "Execution History";
    public override string TaskExecutionBackToTasks => "← Back to Tasks";
    public override string TaskExecutionTaskName => "Task: {0}";
    public override string TaskExecutionDetailTitle => "Task Execution Detail";
    public override string TaskExecutionDetailHeader => "Execution Detail";
    public override string TaskExecutionNoRecords => "No execution records found";
...
public override string AboutPluginListLabel => "Plugin List";
public override string AboutFailedPluginListLabel => "Failed Plugins";
public override string GetSocialMediaName(string platform) => platform switch
    ...
    public override string ConfigPluginDirectoriesLabel => "Plugin Directories";
    public override string ConfigPluginDirAddButton => "Add Directory";
    public override string ConfigDictEmptyMessage => "Dictionary is empty";
    public override string SelectSearchHint => "Clear the input to show all options";
    ...
    public override string UsageTotalRequests => "Total Requests";
    public override string UsageSuccessCount => "Success";
    public override string UsageFailureCount => "Failure";
    public override string UsagePromptTokens => "Prompt Tokens";
    public override string UsageCompletionTokens => "Completion Tokens";
    public override string UsageStartTime => "Start Time";
    public override string UsageEndTime => "End Time";
    public override string UsageFilterButton => "Filter";
    public override string UsageEmptyState => "No usage records found";
    public override string UsageAIClientType => "AI Client";
    public override string UsageAllClientTypes => "All Types";
    public override string UsageGroupByClient => "Group by Client";
    public override string UsageGroupByBeing => "Group by Being";
    public override string UsagePrevPage => "Previous";
    public override string UsageNextPage => "Next";
    public override string UsageBeing => "Being";
    public override string UsageAllBeings => "All Beings";
    public override string UsageTimeToday => "Today";
    public override string UsageTimeWeek => "This Week";
    public override string UsageTimeMonth => "This Month";
    public override string UsageTimeYear => "This Year";
    public override string UsageExport => "Export";
    public override string UsageTrendTitle => "Token Usage Trend";
    public override string UsageTrendPrompt => "Prompt Tokens";
    public override string UsageTrendCompletion => "Completion Tokens";
    public override string UsageTrendTotal => "Total Tokens";
    public override string UsageTooltipDate => "Date";
    public override string UsageTooltipPrompt => "Prompt Tokens";
    public override string UsageTooltipCompletion => "Completion Tokens";
    public override string UsageTooltipTotal => "Total Tokens";

    public override string AuditPageHeader => "Permission Audit Log";
    public override string AuditTotalEntries => "Total Entries";
    public override string AuditAllowedCount => "Allowed";
    public override string AuditDeniedCount => "Denied";
    public override string AuditAskUserCount => "Ask User";
    public override string AuditPermissionType => "Permission Type";
    public override string AuditAllPermissionTypes => "All Types";
    public override string AuditResult => "Result";
    public override string AuditAllResults => "All Results";
    ...
    public override string AuditEmptyState => "No audit entries found";
    public override string AuditPrevPage => "Previous";
    public override string AuditNextPage => "Next";
    public override string AuditColumnCaller => "Caller";
    public override string AuditColumnPermissionType => "Permission Type";
    public override string AuditColumnResource => "Resource";
    public override string AuditColumnResult => "Result";
    public override string AuditColumnReason => "Reason";
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Context Window Tokens",
        ...
        ["VolcengineArkApiKey"] = "API Key",
        ["VolcengineArkEndpointId"] = "Inference Endpoint ID",
        ["HerdsmanClient"] = "Herdsman Client",
        ["HerdsmanEndpoint"] = "Herdsman Endpoint",
        ["HerdsmanModel"] = "Model",
        ["HerdsmanContextWindowTokens"] = "Context Window Tokens",
        ["LongCatClient"] = "LongCat Client",
        ["LongCatApiKey"] = "API Key",
        ["LongCatEndpoint"] = "LongCat Endpoint",
        ["LongCatModel"] = "Model",
        ["LongCatContextWindowTokens"] = "Context Window Tokens",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0 (1M context, 128K output, Agentic) - Recommended",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat (Legacy, 128K)",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat (Legacy, 128K)",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat (Legacy, 128K)",
        ["QiniuAIClient"] = "Qiniu AI Client",
        ["QiniuAIApiKey"] = "API Key",
        ["QiniuAIEndpoint"] = "Qiniu AI Endpoint",
        ["QiniuAIModel"] = "Model",
        ["QiniuAIContextWindowTokens"] = "Context Window Tokens",
        ["DeepSeekClient"] = "DeepSeek Client",
        ["DeepSeekApiKey"] = "API Key",
        ["DeepSeekModel"] = "Model",
        ["DeepSeekEndpoint"] = "Endpoint",
        ["DeepSeekContextWindowTokens"] = "Context Window Tokens",
        ["ZhipuClient"] = "Zhipu Client",
        ["ZhipuApiKey"] = "API Key",
        ["ZhipuModel"] = "Model",
        ["ZhipuEndpoint"] = "Endpoint",
        ["ZhipuContextWindowTokens"] = "Context Window Tokens",
        ["MoonshotClient"] = "Moonshot Client",
        ["MoonshotApiKey"] = "API Key",
        ["MoonshotModel"] = "Model",
        ["MoonshotEndpoint"] = "Endpoint",
        ["MoonshotContextWindowTokens"] = "Context Window Tokens",
        ["SiliconFlowClient"] = "SiliconFlow Client",
        ["SiliconFlowApiKey"] = "API Key",
        ["SiliconFlowModel"] = "Model",
        ["SiliconFlowEndpoint"] = "Endpoint",
        ["SiliconFlowContextWindowTokens"] = "Context Window Tokens",
        ["MiniMaxClient"] = "MiniMax Client",
        ["MiniMaxApiKey"] = "API Key",
        ["MiniMaxModel"] = "Model",
        ["MiniMaxEndpoint"] = "Endpoint",
        ["MiniMaxContextWindowTokens"] = "Context Window Tokens",
        ["ErnieClient"] = "Ernie Client",
        ["ErnieApiKey"] = "API Key",
        ["ErnieModel"] = "Model",
        ["ErnieEndpoint"] = "Endpoint",
        ["ErnieContextWindowTokens"] = "Context Window Tokens",
        ["HunyuanClient"] = "Hunyuan Client",
        ["HunyuanApiKey"] = "API Key",
        ["HunyuanModel"] = "Model",
        ["HunyuanEndpoint"] = "Endpoint",
        ["HunyuanContextWindowTokens"] = "Context Window Tokens",
        ...
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, retires 2026-08-31)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro (Translation, 8K)",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus (Translation, 8K)",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite (Translation, 8K)",
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Context window token capacity for Ollama models, leave empty for auto-detection",
        ...
        ["VolcengineArkEndpointId"] = "Volcengine Ark inference endpoint ID",
        ["HerdsmanEndpoint"] = "Herdsman inference engine API endpoint URL",
        ["HerdsmanModel"] = "Herdsman inference engine model to use",
        ["HerdsmanContextWindowTokens"] = "Context window token capacity for Herdsman models, leave empty to fall back to default message limit",
        ["LongCatApiKey"] = "Meituan LongCat large model API key",
        ["LongCatEndpoint"] = "Meituan LongCat large model API endpoint URL",
        ["LongCatModel"] = "Meituan LongCat large model to use",
        ["LongCatContextWindowTokens"] = "Context window token capacity for LongCat models, leave empty to fall back to default message limit",
        ["QiniuAIApiKey"] = "Qiniu Cloud AI large model inference service API key",
        ["QiniuAIEndpoint"] = "Qiniu Cloud AI large model inference service API endpoint URL",
        ["QiniuAIModel"] = "Qiniu Cloud AI large model inference service model to use",
        ["QiniuAIContextWindowTokens"] = "Context window token capacity for Qiniu AI models, leave empty to fall back to default message limit",
        ["DeepSeekApiKey"] = "DeepSeek API key",
        ["DeepSeekModel"] = "DeepSeek model to use",
        ["DeepSeekEndpoint"] = "DeepSeek API endpoint URL",
        ["DeepSeekContextWindowTokens"] = "Context window token capacity for DeepSeek models, leave empty to fall back to default message limit",
        ["ZhipuApiKey"] = "Zhipu GLM API key",
        ["ZhipuModel"] = "Zhipu GLM model to use",
        ["ZhipuEndpoint"] = "Zhipu GLM API endpoint URL",
        ["ZhipuContextWindowTokens"] = "Context window token capacity for Zhipu models, leave empty to fall back to default message limit",
        ["MoonshotApiKey"] = "Moonshot Kimi API key",
        ["MoonshotModel"] = "Moonshot Kimi model to use",
        ["MoonshotEndpoint"] = "Moonshot Kimi API endpoint URL",
        ["MoonshotContextWindowTokens"] = "Context window token capacity for Moonshot models, leave empty to fall back to default message limit",
        ["SiliconFlowApiKey"] = "SiliconFlow API key",
        ["SiliconFlowModel"] = "SiliconFlow model to use",
        ["SiliconFlowEndpoint"] = "SiliconFlow API endpoint URL",
        ["SiliconFlowContextWindowTokens"] = "Context window token capacity for SiliconFlow models, leave empty to fall back to default message limit",
        ["MiniMaxApiKey"] = "MiniMax API key",
        ["MiniMaxModel"] = "MiniMax model to use",
        ["MiniMaxEndpoint"] = "MiniMax API endpoint URL",
        ["MiniMaxContextWindowTokens"] = "Context window token capacity for MiniMax models, leave empty to fall back to default message limit",
        ["ErnieApiKey"] = "Baidu Ernie API key",
        ["ErnieModel"] = "Baidu Ernie model to use",
        ["ErnieEndpoint"] = "Baidu Ernie API endpoint URL",
        ["ErnieContextWindowTokens"] = "Context window token capacity for Ernie models, leave empty to fall back to default message limit",
        ["HunyuanApiKey"] = "Tencent Hunyuan API key",
        ["HunyuanModel"] = "Tencent Hunyuan model to use",
        ["HunyuanEndpoint"] = "Tencent Hunyuan API endpoint URL",
        ["HunyuanContextWindowTokens"] = "Context window token capacity for Hunyuan models, leave empty to fall back to default message limit",
        ...
        ["MaxContextMessages"] = "Maximum number of recent chat messages loaded into context per AI request (used as the fallback window when the model does not report a context window size)",
    ...
    public override string FormatMemoryEventProject(string content)
        => $"[Project] Project thinking, result: {content}";
    ...
    public override string ProjectAttention_EmptyRolePool => "Empty role pool (no roles assigned yet)";
    public override string ProjectAttention_UnsatisfiedRoles => "Some roles do not meet staffing requirements";
    ...
    public override string ProjectThinkRoundN => "Round {0}";
}
