...
Uso: Llama a la herramienta de chat con action=""mark_read"", target_id=GUID del socio, no se necesita parámetro de mensaje.";
    ...
    public override string WorkflowDetailPageHeader => "Detalles del flujo de trabajo";
    public override string WorkflowRoleAssignmentsHeader => "Asignaciones de roles";
    public override string WorkflowUnassignedBeingsHeader => "Entidades de silicio sin asignar";
    public override string WorkflowNoUnassignedBeings => "Todas las entidades de silicio están asignadas a roles";
    public override string WorkflowStateTransitionsHeader => "Transiciones de estado de tareas";
    public override string WorkflowNoTemplateMessage => "Este proyecto no tiene una plantilla de flujo de trabajo asociada";
    public override string WorkflowNoRoleDefinitions => "Esta plantilla de flujo de trabajo no define roles";
    public override string WorkflowNoTransitions => "Esta plantilla de flujo de trabajo no define transiciones de estado";
    public override string WorkflowRoleAssignedCountLabel => "Asignados";
    public override string WorkflowRoleRequiredCountLabel => "Requerido";
    public override string WorkflowTransitionFromLabel => "Desde";
    public override string WorkflowTransitionToLabel => "Hacia";
    public override string WorkflowAssignRoleButton => "Asignar rol";
    public override string WorkflowRemoveFromRoleButton => "Eliminar";
    ...
    public override string PageTitleSkills => "Gestión de habilidades";
    public override string SkillsPageHeader => "Habilidades";
    public override string SkillsPageSubtitle => "Habilidades = orquestación de herramientas reutilizable + plantillas de prompts (Markdown; metadatos en el front matter YAML)";
    public override string SkillsStatFormat => "{0} habilidad(es) · personalizadas {1}/{2}";
    public override string SkillsEmptyState => "Aún no hay habilidades";
    public override string SkillsBackToBeings => "← Volver a los seres";
    public override string SkillBtnNew => "Nueva habilidad";
    public override string SkillBtnImportMd => "Importar Markdown";
    public override string SkillBtnImportJson => "Importar JSON";
    public override string SkillBtnRefresh => "Actualizar";
    public override string SkillBtnEdit => "Editar";
    public override string SkillBtnTest => "Probar";
    ...
    public override string SkillCurrentEditingFormat => "Editando: {0}";
    public override string SkillNewSkillLabel => "Nueva habilidad (sin guardar)";
    public override string SkillConfirmDeleteFormat => "¿Eliminar la habilidad {0}?";
    public override string SkillPromptImportMd => "Pega el Markdown de la habilidad (front matter YAML + cuerpo; los metadatos que falten se completarán automáticamente)";
    public override string SkillPromptImportJson => "Pega el JSON de SkillDefinition";
    public override string SkillPromptTestParams => "Introduce el JSON de parámetros de prueba (p. ej. {\"source\": \"...\"}), déjalo vacío para ninguno";
    public override string SkillTestResultPrefix => "Resultado: ";
    public override string SkillLoadFailedFormat => "Error al cargar: {0}";
    public override string SkillRequestFailed => "Error en la solicitud";
...
public override string GetSocialMediaName(string platform) => platform switch
    ...
    private static readonly Dictionary<string, string> ConfigGroupNames = new()
    {
        ...
        ["IM"] = "Configuración de IM",
        ["Skill"] = "Configuración de habilidades"
    };
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Tokens de ventana de contexto",
        ...
        ["HerdsmanClient"] = "Cliente Herdsman",
        ["HerdsmanEndpoint"] = "Endpoint de Herdsman",
        ["HerdsmanModel"] = "Modelo",
        ["HerdsmanContextWindowTokens"] = "Tokens de ventana de contexto",
        ["LongCatClient"] = "Cliente LongCat",
        ["LongCatApiKey"] = "Clave API",
        ["LongCatEndpoint"] = "Punto de conexión LongCat",
        ["LongCatModel"] = "Modelo",
        ["LongCatContextWindowTokens"] = "Tokens de ventana de contexto",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0 (1M contexto, 128K salida, Agentic) - Recomendado",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat (Heredado, 128K)",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat (Heredado, 128K)",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat (Heredado, 128K)",
        ["QiniuAIClient"] = "Cliente Qiniu AI",
        ["QiniuAIApiKey"] = "Clave API",
        ["QiniuAIEndpoint"] = "Punto de conexión Qiniu AI",
        ["QiniuAIModel"] = "Modelo",
        ["QiniuAIContextWindowTokens"] = "Tokens de ventana de contexto",
        ["DeepSeekClient"] = "Cliente DeepSeek",
        ["DeepSeekApiKey"] = "Clave API",
        ["DeepSeekModel"] = "Modelo",
        ["DeepSeekEndpoint"] = "Punto de conexión",
        ["DeepSeekContextWindowTokens"] = "Tokens de ventana de contexto",
        ["ZhipuClient"] = "Cliente Zhipu",
        ["ZhipuApiKey"] = "Clave API",
        ["ZhipuModel"] = "Modelo",
        ["ZhipuEndpoint"] = "Punto de conexión",
        ["ZhipuContextWindowTokens"] = "Tokens de ventana de contexto",
        ["MoonshotClient"] = "Cliente Moonshot",
        ["MoonshotApiKey"] = "Clave API",
        ["MoonshotModel"] = "Modelo",
        ["MoonshotEndpoint"] = "Punto de conexión",
        ["MoonshotContextWindowTokens"] = "Tokens de ventana de contexto",
        ["SiliconFlowClient"] = "Cliente SiliconFlow",
        ["SiliconFlowApiKey"] = "Clave API",
        ["SiliconFlowModel"] = "Modelo",
        ["SiliconFlowEndpoint"] = "Punto de conexión",
        ["SiliconFlowContextWindowTokens"] = "Tokens de ventana de contexto",
        ["MiniMaxClient"] = "Cliente MiniMax",
        ["MiniMaxApiKey"] = "Clave API",
        ["MiniMaxModel"] = "Modelo",
        ["MiniMaxEndpoint"] = "Punto de conexión",
        ["MiniMaxContextWindowTokens"] = "Tokens de ventana de contexto",
        ["ErnieClient"] = "Cliente Ernie",
        ["ErnieApiKey"] = "Clave API",
        ["ErnieModel"] = "Modelo",
        ["ErnieEndpoint"] = "Punto de conexión",
        ["ErnieContextWindowTokens"] = "Tokens de ventana de contexto",
        ["HunyuanClient"] = "Cliente Hunyuan",
        ["HunyuanApiKey"] = "Clave API",
        ["HunyuanModel"] = "Modelo",
        ["HunyuanEndpoint"] = "Punto de conexión",
        ["HunyuanContextWindowTokens"] = "Tokens de ventana de contexto",
        ...
        ["ErnieModel_glm-5.2"] = "GLM 5.2 (1M contexto, líder en tareas largas)",
        ["ErnieModel_glm-5.1"] = "GLM 5.1 (codificación mejorada, resultados de ingeniería)",
        ["ErnieModel_deepseek-v4-pro"] = "DeepSeek V4 Pro (millón de contexto, líder en Agent/razonamiento)",
        ["ErnieModel_deepseek-v4-flash"] = "DeepSeek V4 Flash (ligero eficiente, millón de contexto)",
        ["ErnieModel_kimi-k2.6"] = "Kimi K2.6 (código largo, entrada texto/imagen)",
        ["ErnieModel_ernie-5.1"] = "ERNIE 5.1 (último Wenxin, agente/razonamiento mejorado)",
        ["ErnieModel_qianfan-code-latest"] = "qianfan-code-latest (controlado por consola)",
        ["HunyuanModel_hy3"] = "Hy3 (TokenHub, 256K) - Recommended",
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, se retira el 31/08/2026)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro (Traducción, 8K)",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus (Traducción, 8K)",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite (Traducción, 8K)",
        ["HunyuanModel_hunyuan-role-latest"] = "Hy Role Latest (Rol, 32K)",
        ["HunyuanModel_hy-role"] = "Hy Role (Rol, 32K)",
        ...
        ["IMAddPlatform"] = "Añadir plataforma",
        ["IMPlatformType"] = "Tipo de plataforma",
        ["IMEnabledLabel"] = "Habilitado",
        ["IMDeleteLabel"] = "Eliminar",
        ["IMAuthModeLabel"] = "Modo de acceso",
        ["IMManualMode"] = "Credenciales manuales",
        ["IMScanMode"] = "Autorización por código QR",
        ["IMScanAuthorizeBtn"] = "Autorizar con código QR",
        ["IMWaitingAuth"] = "Esperando autorización…",
        ["IMAuthorizedStatus"] = "Autorizado",
        ["IMAuthFailedStatus"] = "Autorización fallida",
        ["IMAuthTimeoutStatus"] = "Autorización caducada",
        ["IMRedirectBaseUrlLabel"] = "URL base de retorno",
        ["IMPublicCallbackHint"] = "Esta plataforma requiere un callback HTTPS público para la primera autorización; configura primero un túnel o una dirección pública",
        ["IMHelpTitle"] = "Guía de configuración",
        ["IMHelpOfficialDoc"] = "Documentación oficial",
        ["IMHelp_webui"] = "Interfaz de chat integrada en el navegador servida directamente por esta aplicación. No se requieren credenciales externas — solo actívala y chatea desde la página web.",
        ["IMHelp_feishu"] = "Crea una aplicación personalizada en la Feishu Open Platform, habilita la capacidad de bot y publica una versión. Copia el App ID y el App Secret desde 'Credentials & Basic Info', y el Verification Token / Encrypt Key desde 'Event Subscriptions'. Apunta la URL de solicitud de suscripción de eventos a la ruta de callback de esta aplicación; Feishu permite callbacks a localhost, por lo que no se necesita una dirección pública para pruebas locales.",
        ["IMHelp_wecom"] = "Crea una aplicación propia en la consola de administración de WeCom (Apps → Create App). Rellena el Corp ID (My Company → Company Info), el Agent ID y el App Secret de la aplicación, además del Token y la Encoding AES Key generados al configurar el 'servidor de recepción de mensajes'. La URL de callback debe ser una dirección HTTPS accesible públicamente que apunte a la ruta de callback de esta aplicación, y puede ser necesario añadir la IP del servidor a la lista de IP de confianza.",
        ["IMHelp_dingtalk"] = "Crea una aplicación empresarial interna con un robot en la DingTalk Open Platform. Rellena el App Key, el App Secret y el Robot Code desde la página de credenciales de la aplicación. El modo Stream (predeterminado) recibe mensajes a través de una conexión WebSocket y no necesita dirección pública; el modo de callback HTTP requiere una URL de callback HTTPS accesible públicamente.",
        ["SkillEnabled"] = "Habilitar habilidades",
        ["MaxContextMessages"] = "Máximo de mensajes de contexto",
        ["GlobalMaxToolRound"] = "Rondas máximas de herramientas globales",
        ["GlobalSkillTimeoutSeconds"] = "Tiempo de espera global de habilidades (s)",
        ["MaxCustomSkillsPerBeing"] = "Habilidades personalizadas máx. por ser"
    };
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos Ollama, dejar vacío para detección automática",
        ...
        ["HerdsmanEndpoint"] = "URL del endpoint API del motor de inferencia Herdsman",
        ["HerdsmanModel"] = "Modelo utilizado por el motor de inferencia Herdsman",
        ["HerdsmanContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos Herdsman, dejar vacío para volver al límite de mensajes predeterminado",
        ["LongCatApiKey"] = "Clave API del modelo grande LongCat de Meituan",
        ["LongCatEndpoint"] = "URL del punto de conexión API del modelo grande LongCat de Meituan",
        ["LongCatModel"] = "Modelo a utilizar del modelo grande LongCat de Meituan",
        ["LongCatContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos LongCat, dejar vacío para volver al límite de mensajes predeterminado",
        ["QiniuAIApiKey"] = "Clave API del servicio de inferencia de modelo grande Qiniu Cloud AI",
        ["QiniuAIEndpoint"] = "URL del punto de conexión API del servicio de inferencia de modelo grande Qiniu Cloud AI",
        ["QiniuAIModel"] = "Modelo a utilizar del servicio de inferencia de modelo grande Qiniu Cloud AI",
        ["QiniuAIContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos Qiniu AI, dejar vacío para volver al límite de mensajes predeterminado",
        ["DeepSeekApiKey"] = "Clave API de DeepSeek",
        ["DeepSeekModel"] = "Modelo de DeepSeek a utilizar",
        ["DeepSeekEndpoint"] = "URL del punto de conexión API de DeepSeek",
        ["DeepSeekContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos DeepSeek, dejar vacío para volver al límite de mensajes predeterminado",
        ["ZhipuApiKey"] = "Clave API de Zhipu GLM",
        ["ZhipuModel"] = "Modelo de Zhipu GLM a utilizar",
        ["ZhipuEndpoint"] = "URL del punto de conexión API de Zhipu GLM",
        ["ZhipuContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos Zhipu, dejar vacío para volver al límite de mensajes predeterminado",
        ["MoonshotApiKey"] = "Clave API de Moonshot Kimi",
        ["MoonshotModel"] = "Modelo de Moonshot Kimi a utilizar",
        ["MoonshotEndpoint"] = "URL del punto de conexión API de Moonshot Kimi",
        ["MoonshotContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos Moonshot, dejar vacío para volver al límite de mensajes predeterminado",
        ["SiliconFlowApiKey"] = "Clave API de SiliconFlow",
        ["SiliconFlowModel"] = "Modelo de SiliconFlow a utilizar",
        ["SiliconFlowEndpoint"] = "URL del punto de conexión API de SiliconFlow",
        ["SiliconFlowContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos SiliconFlow, dejar vacío para volver al límite de mensajes predeterminado",
        ["MiniMaxApiKey"] = "Clave API de MiniMax",
        ["MiniMaxModel"] = "Modelo de MiniMax a utilizar",
        ["MiniMaxEndpoint"] = "URL del punto de conexión API de MiniMax",
        ["MiniMaxContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos MiniMax, dejar vacío para volver al límite de mensajes predeterminado",
        ["ErnieApiKey"] = "Clave API de Baidu Ernie",
        ["ErnieModel"] = "Modelo de Baidu Ernie a utilizar",
        ["ErnieEndpoint"] = "URL del punto de conexión API de Baidu Ernie",
        ["ErnieContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos Ernie, dejar vacío para volver al límite de mensajes predeterminado",
        ["HunyuanApiKey"] = "Clave API de Tencent Hunyuan",
        ["HunyuanModel"] = "Modelo de Tencent Hunyuan a utilizar",
        ["HunyuanEndpoint"] = "URL del punto de conexión API de Tencent Hunyuan",
        ["HunyuanContextWindowTokens"] = "Capacidad de tokens de ventana de contexto para modelos Hunyuan, dejar vacío para volver al límite de mensajes predeterminado",
        ...
        ["IMPlatforms"] = "Configura las plataformas de IM conectadas; añade varias, mediante credenciales manuales o autorización por código QR",
        ["SkillEnabled"] = "Habilitar el sistema de habilidades (registro de habilidades, dispatch de IA y disparadores automáticos)",
        ["MaxContextMessages"] = "Número máximo de mensajes de chat recientes cargados en el contexto por solicitud de IA (se usa como ventana de reserva cuando el modelo no informa del tamaño de su ventana de contexto)",
        ["GlobalMaxToolRound"] = "Límite superior de rondas de llamadas a herramientas por ejecución de habilidad",
        ["GlobalSkillTimeoutSeconds"] = "Límite superior de la duración de ejecución de una habilidad en segundos",
        ["MaxCustomSkillsPerBeing"] = "Número máximo de habilidades personalizadas (no integradas) que cada ser de silicio puede poseer"
    };
    ...
    public override string ProjectCtx_ProjectInfoHeader => "Afiliación al proyecto";
    public override string ProjectCtx_ProjectInfoRoleLabel => "Rol";
    ...
    public override string ProjectThinkHistoryLinkLabel => "Historial de procesamiento";
    public override string ProjectThinkHistoryTitle => "Historial de procesamiento del proyecto";
    public override string ProjectThinkHistoryHeader => "Historial de procesamiento";
    public override string ProjectThinkBackToProjects => "← Volver a proyectos";
    public override string ProjectThinkProjectName => "Proyecto: {0}";
    public override string ProjectThinkNoRecords => "Sin sesiones de procesamiento";
    public override string ProjectThinkStateStarted => "Iniciado";
    public override string ProjectThinkStateExecuting => "En ejecución";
    public override string ProjectThinkStateCompleted => "Completado";
    public override string ProjectThinkStateFailed => "Fallido";
    public override string ProjectThinkDetailTitle => "Detalle de sesión";
    public override string ProjectThinkDetailHeader => "Detalle de sesión";
    public override string ProjectThinkRoundLabel => "Ronda: ";
    public override string ProjectThinkMessageCountLabel => "Mensajes: ";
    public override string ProjectThinkStateLabel => "Estado: ";
    public override string ProjectThinkCreatedAt => "Creado: ";
    public override string ProjectThinkCompletedAt => "Completado: ";
    public override string ProjectThinkCycleLabel => "Ciclo";
    public override string ProjectThinkRoundN => "Ronda {0}";
}
