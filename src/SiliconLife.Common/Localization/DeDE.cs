...
_ => permissionType.ToString()
    ...
    public override string PageTitleAudit => "Berechtigungs-Audit - Silicon Life Collective";
    ...
    public override string WorkflowDetailPageHeader => "Arbeitsablauf-Details";
    public override string WorkflowRoleAssignmentsHeader => "Rollenzuweisungen";
    public override string WorkflowUnassignedBeingsHeader => "Nicht zugewiesene Siliziumwesen";
    public override string WorkflowNoUnassignedBeings => "Alle Siliziumwesen sind Rollen zugewiesen";
    public override string WorkflowStateTransitionsHeader => "Aufgabenzustandsübergänge";
    public override string WorkflowNoTemplateMessage => "Diesem Projekt ist keine Arbeitsablaufvorlage zugeordnet";
    public override string WorkflowNoRoleDefinitions => "Diese Arbeitsablaufvorlage definiert keine Rollen";
    public override string WorkflowNoTransitions => "Diese Arbeitsablaufvorlage definiert keine Zustandsübergänge";
    public override string WorkflowRoleAssignedCountLabel => "Zugewiesen";
    public override string WorkflowRoleRequiredCountLabel => "Erforderlich";
    public override string WorkflowTransitionFromLabel => "Von";
    public override string WorkflowTransitionToLabel => "Nach";
    public override string WorkflowAssignRoleButton => "Rolle zuweisen";
    public override string WorkflowRemoveFromRoleButton => "Entfernen";
    public override string WorkflowTerminalStateLabel => "Endzustand";
    public override string WorkflowInitialStateLabel => "Anfangszustand";
...
public override string AboutFailedPluginListLabel => "Fehlerhaft geladene Plugins";
public override string GetSocialMediaName(string platform) => platform switch
    ...
    public override string ConfigPluginDirectoriesLabel => "Plugin-Verzeichnisse";
    public override string ConfigPluginDirAddButton => "Verzeichnis hinzufügen";
    ...
    public override string AuditPageHeader => "Berechtigungs-Audit-Protokoll";
    public override string AuditTotalEntries => "Gesamteinträge";
    public override string AuditAllowedCount => "Erlaubt";
    public override string AuditDeniedCount => "Verweigert";
    public override string AuditAskUserCount => "Benutzer fragen";
    public override string AuditPermissionType => "Berechtigungstyp";
    public override string AuditAllPermissionTypes => "Alle Typen";
    public override string AuditResult => "Ergebnis";
    public override string AuditAllResults => "Alle Ergebnisse";
    public override string AuditBeing => "Silicon Being";
    public override string AuditAllBeings => "Alle Beings";
    public override string AuditStartTime => "Startzeit";
    public override string AuditEndTime => "Endzeit";
    public override string AuditFilterButton => "Filtern";
    public override string AuditEmptyState => "Keine Audit-Einträge gefunden";
    public override string AuditPrevPage => "Zurück";
    public override string AuditNextPage => "Weiter";
    public override string AuditColumnCaller => "Aufrufer";
    public override string AuditColumnPermissionType => "Berechtigungstyp";
    public override string AuditColumnResource => "Ressource";
    public override string AuditColumnResult => "Ergebnis";
    public override string AuditColumnReason => "Grund";
    public override string AuditColumnTimestamp => "Zeitstempel";
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Kontextfenster-Tokens",
        ...
        ["HerdsmanEndpoint"] = "Herdsman-Endpunkt",
        ["HerdsmanModel"] = "Modell",
        ["HerdsmanContextWindowTokens"] = "Kontextfenster-Tokens",
        ["LongCatClient"] = "LongCat-Client",
        ["LongCatApiKey"] = "API-Schlüssel",
        ["LongCatEndpoint"] = "LongCat-Endpunkt",
        ["LongCatModel"] = "Modell",
        ["LongCatContextWindowTokens"] = "Kontextfenster-Tokens",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0 (1M Kontext, 128K Ausgabe, Agentic) - Empfohlen",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat (Veraltet, 128K)",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat (Veraltet, 128K)",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat (Veraltet, 128K)",
        ["QiniuAIClient"] = "Qiniu AI-Client",
        ["QiniuAIApiKey"] = "API-Schlüssel",
        ["QiniuAIEndpoint"] = "Qiniu AI-Endpunkt",
        ["QiniuAIModel"] = "Modell",
        ["QiniuAIContextWindowTokens"] = "Kontextfenster-Tokens",
        ["DeepSeekClient"] = "DeepSeek-Client",
        ["DeepSeekApiKey"] = "API-Schlüssel",
        ["DeepSeekModel"] = "Modell",
        ["DeepSeekEndpoint"] = "Endpunkt",
        ["DeepSeekContextWindowTokens"] = "Kontextfenster-Tokens",
        ["ZhipuClient"] = "Zhipu-Client",
        ["ZhipuApiKey"] = "API-Schlüssel",
        ["ZhipuModel"] = "Modell",
        ["ZhipuEndpoint"] = "Endpunkt",
        ["ZhipuContextWindowTokens"] = "Kontextfenster-Tokens",
        ["MoonshotClient"] = "Moonshot-Client",
        ["MoonshotApiKey"] = "API-Schlüssel",
        ["MoonshotModel"] = "Modell",
        ["MoonshotEndpoint"] = "Endpunkt",
        ["MoonshotContextWindowTokens"] = "Kontextfenster-Tokens",
        ["SiliconFlowClient"] = "SiliconFlow-Client",
        ["SiliconFlowApiKey"] = "API-Schlüssel",
        ["SiliconFlowModel"] = "Modell",
        ["SiliconFlowEndpoint"] = "Endpunkt",
        ["SiliconFlowContextWindowTokens"] = "Kontextfenster-Tokens",
        ["MiniMaxClient"] = "MiniMax-Client",
        ["MiniMaxApiKey"] = "API-Schlüssel",
        ["MiniMaxModel"] = "Modell",
        ["MiniMaxEndpoint"] = "Endpunkt",
        ["MiniMaxContextWindowTokens"] = "Kontextfenster-Tokens",
        ["ErnieClient"] = "Ernie-Client",
        ["ErnieApiKey"] = "API-Schlüssel",
        ["ErnieModel"] = "Modell",
        ["ErnieEndpoint"] = "Endpunkt",
        ["ErnieContextWindowTokens"] = "Kontextfenster-Tokens",
        ["HunyuanClient"] = "Hunyuan-Client",
        ["HunyuanApiKey"] = "API-Schlüssel",
        ["HunyuanModel"] = "Modell",
        ["HunyuanEndpoint"] = "Endpunkt",
        ["HunyuanContextWindowTokens"] = "Kontextfenster-Tokens",
        ...
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, wird am 31.08.2026 eingestellt)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro (Übersetzung, 8K)",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus (Übersetzung, 8K)",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite (Übersetzung, 8K)",
        ["HunyuanModel_hunyuan-role-latest"] = "Hy Role Latest (Rollenspiel, 32K)",
        ["HunyuanModel_hy-role"] = "Hy Role (Rollenspiel, 32K)",
        ...
        ["MaxContextMessages"] = "Maximale Kontext-Nachrichten",
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Kontextfenster-Token-Kapazität für Ollama-Modelle, leer für automatische Erkennung",
        ...
        ["HerdsmanEndpoint"] = "Herdsman-Inferenz-Engine API-Endpunkt-URL",
        ["HerdsmanModel"] = "Von der Herdsman-Inferenz-Engine verwendetes Modell",
        ["HerdsmanContextWindowTokens"] = "Kontextfenster-Token-Kapazität für Herdsman-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["LongCatApiKey"] = "Meituan LongCat Large Model API-Schlüssel",
        ["LongCatEndpoint"] = "Meituan LongCat Large Model API-Endpunkt-URL",
        ["LongCatModel"] = "Meituan LongCat Large Model zu verwendendes Modell",
        ["LongCatContextWindowTokens"] = "Kontextfenster-Token-Kapazität für LongCat-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["QiniuAIApiKey"] = "Qiniu Cloud AI Large Model Inferenzdienst API-Schlüssel",
        ["QiniuAIEndpoint"] = "Qiniu Cloud AI Large Model Inferenzdienst API-Endpunkt-URL",
        ["QiniuAIModel"] = "Qiniu Cloud AI Large Model Inferenzdienst zu verwendendes Modell",
        ["QiniuAIContextWindowTokens"] = "Kontextfenster-Token-Kapazität für Qiniu AI-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["DeepSeekApiKey"] = "DeepSeek API-Schlüssel",
        ["DeepSeekModel"] = "Zu verwendendes DeepSeek-Modell",
        ["DeepSeekEndpoint"] = "DeepSeek API-Endpunkt-URL",
        ["DeepSeekContextWindowTokens"] = "Kontextfenster-Token-Kapazität für DeepSeek-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["ZhipuApiKey"] = "Zhipu GLM API-Schlüssel",
        ["ZhipuModel"] = "Zu verwendendes Zhipu GLM-Modell",
        ["ZhipuEndpoint"] = "Zhipu GLM API-Endpunkt-URL",
        ["ZhipuContextWindowTokens"] = "Kontextfenster-Token-Kapazität für Zhipu-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["MoonshotApiKey"] = "Moonshot Kimi API-Schlüssel",
        ["MoonshotModel"] = "Zu verwendendes Moonshot Kimi-Modell",
        ["MoonshotEndpoint"] = "Moonshot Kimi API-Endpunkt-URL",
        ["MoonshotContextWindowTokens"] = "Kontextfenster-Token-Kapazität für Moonshot-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["SiliconFlowApiKey"] = "SiliconFlow API-Schlüssel",
        ["SiliconFlowModel"] = "Zu verwendendes SiliconFlow-Modell",
        ["SiliconFlowEndpoint"] = "SiliconFlow API-Endpunkt-URL",
        ["SiliconFlowContextWindowTokens"] = "Kontextfenster-Token-Kapazität für SiliconFlow-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["MiniMaxApiKey"] = "MiniMax API-Schlüssel",
        ["MiniMaxModel"] = "Zu verwendendes MiniMax-Modell",
        ["MiniMaxEndpoint"] = "MiniMax API-Endpunkt-URL",
        ["MiniMaxContextWindowTokens"] = "Kontextfenster-Token-Kapazität für MiniMax-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["ErnieApiKey"] = "Baidu Ernie API-Schlüssel",
        ["ErnieModel"] = "Zu verwendendes Baidu Ernie-Modell",
        ["ErnieEndpoint"] = "Baidu Ernie API-Endpunkt-URL",
        ["ErnieContextWindowTokens"] = "Kontextfenster-Token-Kapazität für Ernie-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ["HunyuanApiKey"] = "Tencent Hunyuan API-Schlüssel",
        ["HunyuanModel"] = "Zu verwendendes Tencent Hunyuan-Modell",
        ["HunyuanEndpoint"] = "Tencent Hunyuan API-Endpunkt-URL",
        ["HunyuanContextWindowTokens"] = "Kontextfenster-Token-Kapazität für Hunyuan-Modelle, leer für Fallback auf Standardnachrichtenlimit",
        ...
        ["MaxContextMessages"] = "Maximale Anzahl kürzlicher Chat-Nachrichten, die pro KI-Anfrage in den Kontext geladen werden (als Fallback-Fenster verwendet, wenn das Modell keine Kontextfenstergröße meldet)",
    ...
    public override string GetBeingActivityName(BeingActivity activity) => activity switch
    {
        ...
        BeingActivity.Broadcast => "Broadcast verarbeiten",
        BeingActivity.Project => "Projektarbeit",
...
Verwendung: Rufe das chat-Tool auf, setze action=""mark_read"", target_id=Gegenüber-GUID, kein message-Parameter erforderlich.";
    ...
    public override string ProjectCtx_ProjectInfoHeader => "Projektzugehörigkeit";
