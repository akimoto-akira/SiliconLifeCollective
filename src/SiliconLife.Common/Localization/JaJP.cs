...
使用方法：chat ツールを呼び出し、action=""mark_read""、target_id=相手のGUID を設定。message パラメータは不要です。";
    ...
    public override string WorkflowDetailPageHeader => "ワークフロー詳細";
    public override string WorkflowRoleAssignmentsHeader => "ロール割り当て";
    public override string WorkflowUnassignedBeingsHeader => "未割り当てのシリコンビーイング";
    public override string WorkflowNoUnassignedBeings => "すべてのシリコンビーイングにロールが割り当てられています";
    public override string WorkflowStateTransitionsHeader => "タスク状態遷移";
    public override string WorkflowNoTemplateMessage => "このプロジェクトにワークフローテンプレートが関連付けられていません";
    public override string WorkflowNoRoleDefinitions => "このワークフローテンプレートにはロール定義がありません";
    public override string WorkflowNoTransitions => "このワークフローテンプレートには状態遷移が定義されていません";
    public override string WorkflowRoleAssignedCountLabel => "割り当て済み";
    public override string WorkflowRoleRequiredCountLabel => "必要";
    public override string WorkflowTransitionFromLabel => "遷移元";
    public override string WorkflowTransitionToLabel => "遷移先";
    public override string WorkflowAssignRoleButton => "ロール割り当て";
    public override string WorkflowRemoveFromRoleButton => "削除";
    public override string WorkflowTerminalStateLabel => "終了状態";
    public override string WorkflowInitialStateLabel => "初期状態";
    ...
    public override string ToolAuthSaveSuccess => "ツール認可設定を保存しました";
    public override string ToolAuthSaveFailed => "保存に失敗しました";
    public override string ToolAuthDialogClose => "閉じる";
    public override string ToolAuthNoDeclaredActions => "設定不可";
...
public override string GetSocialMediaName(string platform) => platform switch
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["Temperature"] = "温度",
        ["MaxTokens"] = "最大Token数",
        ["OllamaContextWindowTokens"] = "コンテキストウィンドウTokens",
        ...
        ["HerdsmanClient"] = "Herdsmanクライアント",
        ["HerdsmanEndpoint"] = "Herdsmanエンドポイント",
        ["HerdsmanModel"] = "モデル",
        ["HerdsmanContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["LongCatClient"] = "LongCatクライアント",
        ["LongCatApiKey"] = "APIキー",
        ["LongCatEndpoint"] = "LongCatエンドポイント",
        ["LongCatModel"] = "モデル",
        ["LongCatContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0（1Mコンテキスト、128K出力、Agentic）- 推奨",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat（レガシー、128K）",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat（レガシー、128K）",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat（レガシー、128K）",
        ["QiniuAIClient"] = "Qiniu AIクライアント",
        ["QiniuAIApiKey"] = "APIキー",
        ["QiniuAIEndpoint"] = "Qiniu AIエンドポイント",
        ["QiniuAIModel"] = "モデル",
        ["QiniuAIContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["DeepSeekClient"] = "DeepSeekクライアント",
        ["DeepSeekApiKey"] = "APIキー",
        ["DeepSeekModel"] = "モデル",
        ["DeepSeekEndpoint"] = "エンドポイント",
        ["DeepSeekContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["ZhipuClient"] = "Zhipuクライアント",
        ["ZhipuApiKey"] = "APIキー",
        ["ZhipuModel"] = "モデル",
        ["ZhipuEndpoint"] = "エンドポイント",
        ["ZhipuContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["MoonshotClient"] = "Moonshotクライアント",
        ["MoonshotApiKey"] = "APIキー",
        ["MoonshotModel"] = "モデル",
        ["MoonshotEndpoint"] = "エンドポイント",
        ["MoonshotContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["SiliconFlowClient"] = "SiliconFlowクライアント",
        ["SiliconFlowApiKey"] = "APIキー",
        ["SiliconFlowModel"] = "モデル",
        ["SiliconFlowEndpoint"] = "エンドポイント",
        ["SiliconFlowContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["MiniMaxClient"] = "MiniMaxクライアント",
        ["MiniMaxApiKey"] = "APIキー",
        ["MiniMaxModel"] = "モデル",
        ["MiniMaxEndpoint"] = "エンドポイント",
        ["MiniMaxContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["ErnieClient"] = "Ernieクライアント",
        ["ErnieApiKey"] = "APIキー",
        ["ErnieModel"] = "モデル",
        ["ErnieEndpoint"] = "エンドポイント",
        ["ErnieContextWindowTokens"] = "コンテキストウィンドウTokens",
        ["HunyuanClient"] = "Hunyuanクライアント",
        ["HunyuanApiKey"] = "APIキー",
        ["HunyuanModel"] = "モデル",
        ["HunyuanEndpoint"] = "エンドポイント",
        ["HunyuanContextWindowTokens"] = "コンテキストウィンドウTokens",
        ...
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, 2026-08-31 に提供終了)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro（翻訳，8K）",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus（翻訳，8K）",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite（翻訳，8K）",
        ["HunyuanModel_hunyuan-role-latest"] = "Hy Role Latest（ロールプレイ，32K）",
        ["HunyuanModel_hy-role"] = "Hy Role（ロールプレイ，32K）",
        ...
        ["MaxContextMessages"] = "コンテキスト最大メッセージ数",
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "OllamaモデルのコンテキストウィンドウToken容量、空欄なら自動検出",
        ...
        ["HerdsmanEndpoint"] = "Herdsman推論エンジンAPIエンドポイントURL",
        ["HerdsmanModel"] = "Herdsman推論エンジンで使用するモデル",
        ["HerdsmanContextWindowTokens"] = "Herdsman推論エンジンモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["LongCatApiKey"] = "美団LongCat大模型APIキー",
        ["LongCatEndpoint"] = "美団LongCat大模型APIエンドポイントURL",
        ["LongCatModel"] = "美団LongCat大モデルで使用するモデル",
        ["LongCatContextWindowTokens"] = "LongCatモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["QiniuAIApiKey"] = "七牛雲AI大モデル推論サービスAPIキー",
        ["QiniuAIEndpoint"] = "七牛雲AI大モデル推論サービスAPIエンドポイントURL",
        ["QiniuAIModel"] = "七牛雲AI大モデル推論サービスで使用するモデル",
        ["QiniuAIContextWindowTokens"] = "Qiniu AIモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["DeepSeekApiKey"] = "DeepSeek APIキー",
        ["DeepSeekModel"] = "DeepSeekで使用するモデル",
        ["DeepSeekEndpoint"] = "DeepSeek APIエンドポイントURL",
        ["DeepSeekContextWindowTokens"] = "DeepSeekモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["ZhipuApiKey"] = "Zhipu GLM APIキー",
        ["ZhipuModel"] = "Zhipu GLMで使用するモデル",
        ["ZhipuEndpoint"] = "Zhipu GLM APIエンドポイントURL",
        ["ZhipuContextWindowTokens"] = "ZhipuモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["MoonshotApiKey"] = "Moonshot Kimi APIキー",
        ["MoonshotModel"] = "Moonshot Kimiで使用するモデル",
        ["MoonshotEndpoint"] = "Moonshot Kimi APIエンドポイントURL",
        ["MoonshotContextWindowTokens"] = "MoonshotモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["SiliconFlowApiKey"] = "SiliconFlow APIキー",
        ["SiliconFlowModel"] = "SiliconFlowで使用するモデル",
        ["SiliconFlowEndpoint"] = "SiliconFlow APIエンドポイントURL",
        ["SiliconFlowContextWindowTokens"] = "SiliconFlowモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["MiniMaxApiKey"] = "MiniMax APIキー",
        ["MiniMaxModel"] = "MiniMaxで使用するモデル",
        ["MiniMaxEndpoint"] = "MiniMax APIエンドポイントURL",
        ["MiniMaxContextWindowTokens"] = "MiniMaxモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["ErnieApiKey"] = "Baidu Ernie APIキー",
        ["ErnieModel"] = "Baidu Ernieで使用するモデル",
        ["ErnieEndpoint"] = "Baidu Ernie APIエンドポイントURL",
        ["ErnieContextWindowTokens"] = "ErnieモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["HunyuanApiKey"] = "Tencent Hunyuan APIキー",
        ["HunyuanModel"] = "Tencent Hunyuanで使用するモデル",
        ["HunyuanEndpoint"] = "Tencent Hunyuan APIエンドポイントURL",
        ["HunyuanContextWindowTokens"] = "HunyuanモデルのコンテキストウィンドウToken容量、空欄ならデフォルトメッセージ制限にフォールバック",
        ["WebPort"] = "Webサーバーポート",
        ["WebSkin"] = "Webスキン名",
        ...
        ["MaxContextMessages"] = "AI リクエストごとにコンテキストへ読み込む最近のチャットメッセージの最大数（モデルがコンテキストウィンドウサイズを報告しない場合のフォールバックとして使用）",
    ...
    public override string GetBeingActivityName(BeingActivity activity) => activity switch
    {
        ...
        BeingActivity.Broadcast => "ブロードキャスト処理中",
        BeingActivity.Project => "プロジェクト作業中",
    ...
    public override string ProjectCtx_RoleNeedsAttention => "⚠ {0}つのロールが人員不足です。シリコンビーイングを作成し、ロールに割り当てる必要があります";
    public override string ProjectCtx_StaffingActionPlanHeader => "人員配置アクションプラン";
    public override string ProjectCtx_TotalBeingsNeeded => "作成が必要なシリコンビーイング総数：{0}";
    public override string ProjectCtx_StaffingRoleBreakdownHeader => "ロール別人員不足の内訳";
    public override string ProjectCtx_RoleShortageDetail => "{0}：必要{1}名、現在{2}名 → {3}名不足";
    public override string ProjectCtx_StaffingActionStepsHeader => "推奨操作手順";
    public override string ProjectCtx_StaffingStepCreateBeings => "1. silicon_manager の create_being で {0} 体のシリコンビーイングを作成（各ロールに最低1体）";
    public override string ProjectCtx_StaffingStepAssignToProject => "2. project の assign で新規作成したシリコンビーイングをプロジェクトに追加";
    public override string ProjectCtx_StaffingStepAssignToRoles => "3. project の assign_role で各シリコンビーイングを対応するロールに割り当て";
    public override string ProjectCtx_EmptyRolePoolAction => "⚠ ロールプールが空です！ワークフローは{0}個のロールを定義しています。シリコンビーイングを作成し、各ロールに割り当ててください";
    ...
    public override string ProjectCtx_AvailableBeingsHeader => "利用可能なシリコンビーイング（本プロジェクトに未割り当て）";
    public override string ProjectCtx_AvailableBeingsHint => "ヒント：新規作成する前に、既存のビーイングをロールに割り当てることを優先してください。project assign と project assign_role を使用。";
