...
使用方法：調用 chat 工具，設定 action=""mark_read""，target_id=對方GUID，無需 message 參數。";
    ...
    public override string PageTitleWorkNotes => "工作筆記 - 矽基生命群";
    ...
    public override string PageTitleAudit => "權限審計 - 矽基生命群";
    ...
    public override string WorkNotesNoSearchResults => "未找到匹配的筆記";
    ...
    public override string ProjectGroupChatLinkLabel => "項目群聊";
    public override string ProjectBroadcastLinkLabel => "項目廣播";
    ...
    public override string WorkflowDetailPageHeader => "工作流詳情";
    public override string WorkflowRoleAssignmentsHeader => "角色分配";
    public override string WorkflowUnassignedBeingsHeader => "未分配角色的矽基人";
    public override string WorkflowNoUnassignedBeings => "所有矽基人均已分配角色";
    public override string WorkflowStateTransitionsHeader => "任務狀態流轉";
    public override string WorkflowNoTemplateMessage => "該項目未關聯工作流模板";
    public override string WorkflowNoRoleDefinitions => "該工作流模板未定義角色";
    public override string WorkflowNoTransitions => "該工作流模板未定義狀態轉換";
    public override string WorkflowRoleAssignedCountLabel => "已分配";
    public override string WorkflowRoleRequiredCountLabel => "需要";
    public override string WorkflowTransitionFromLabel => "從";
    public override string WorkflowTransitionToLabel => "到";
    public override string WorkflowAssignRoleButton => "分配角色";
    public override string WorkflowRemoveFromRoleButton => "移除";
    public override string WorkflowTerminalStateLabel => "終態";
    public override string WorkflowInitialStateLabel => "初始狀態";
    ...
    public override string ToolAuthSaveSuccess => "工具授權配置已儲存成功";
    public override string ToolAuthSaveFailed => "儲存失敗";
    public override string ToolAuthDialogClose => "關閉";
    public override string ToolAuthNoDeclaredActions => "無法設定";
    ...
    public override string ChatDetailMembers => "成員";
...
public override string AboutFailedPluginListLabel => "載入失敗的插件";
...
public override string GetSocialMediaName(string platform) => platform switch
    ...
    public override string AuditPageHeader => "權限審計日誌";
    public override string AuditTotalEntries => "總記錄數";
    public override string AuditAllowedCount => "允許";
    public override string AuditDeniedCount => "拒絕";
    public override string AuditAskUserCount => "詢問使用者";
    public override string AuditPermissionType => "權限類型";
    public override string AuditAllPermissionTypes => "全部類型";
    public override string AuditResult => "結果";
    public override string AuditAllResults => "全部結果";
    ...
    public override string AuditFilterButton => "篩選";
    ...
    public override string AuditColumnCaller => "呼叫者";
    public override string AuditColumnPermissionType => "權限類型";
    public override string AuditColumnResource => "資源";
    public override string AuditColumnResult => "結果";
    public override string AuditColumnReason => "原因";
    public override string AuditColumnTimestamp => "時間";
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "上下文視窗 Tokens",
        ...
        ["HerdsmanClient"] = "牧馬人推理引擎客戶端",
        ["HerdsmanEndpoint"] = "牧馬人端點",
        ["HerdsmanModel"] = "模型",
        ["HerdsmanContextWindowTokens"] = "上下文視窗 Tokens",
        ["LongCatClient"] = "LongCat 客戶端",
        ["LongCatApiKey"] = "API 密鑰",
        ["LongCatEndpoint"] = "LongCat 端點",
        ["LongCatModel"] = "模型",
        ["LongCatContextWindowTokens"] = "上下文視窗 Tokens",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0（1M 上下文，128K 輸出，Agentic）- 推薦",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat（舊版，128K）",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat（舊版，128K）",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat（舊版，128K）",
        ["QiniuAIClient"] = "七牛雲 AI 客戶端",
        ["QiniuAIApiKey"] = "API 密鑰",
        ["QiniuAIEndpoint"] = "七牛雲端點",
        ["QiniuAIModel"] = "模型",
        ["QiniuAIContextWindowTokens"] = "上下文視窗 Tokens",
        ["DeepSeekClient"] = "DeepSeek 客戶端",
        ["DeepSeekApiKey"] = "API 密鑰",
        ["DeepSeekModel"] = "模型",
        ["DeepSeekEndpoint"] = "端點",
        ["DeepSeekContextWindowTokens"] = "上下文視窗 Tokens",
        ["ZhipuClient"] = "智譜客戶端",
        ["ZhipuApiKey"] = "API 密鑰",
        ["ZhipuModel"] = "模型",
        ["ZhipuEndpoint"] = "端點",
        ["ZhipuContextWindowTokens"] = "上下文視窗 Tokens",
        ["MoonshotClient"] = "月之暗面客戶端",
        ["MoonshotApiKey"] = "API 密鑰",
        ["MoonshotModel"] = "模型",
        ["MoonshotEndpoint"] = "端點",
        ["MoonshotContextWindowTokens"] = "上下文視窗 Tokens",
        ["SiliconFlowClient"] = "硅基流動客戶端",
        ["SiliconFlowApiKey"] = "API 密鑰",
        ["SiliconFlowModel"] = "模型",
        ["SiliconFlowEndpoint"] = "端點",
        ["SiliconFlowContextWindowTokens"] = "上下文視窗 Tokens",
        ["MiniMaxClient"] = "MiniMax 客戶端",
        ["MiniMaxApiKey"] = "API 密鑰",
        ["MiniMaxModel"] = "模型",
        ["MiniMaxEndpoint"] = "端點",
        ["MiniMaxContextWindowTokens"] = "上下文視窗 Tokens",
        ["ErnieClient"] = "文心客戶端",
        ["ErnieApiKey"] = "API 密鑰",
        ["ErnieModel"] = "模型",
        ["ErnieEndpoint"] = "端點",
        ["ErnieContextWindowTokens"] = "上下文視窗 Tokens",
        ["HunyuanClient"] = "混元客戶端",
        ["HunyuanApiKey"] = "API 密鑰",
        ["HunyuanModel"] = "模型",
        ["HunyuanEndpoint"] = "端點",
        ["HunyuanContextWindowTokens"] = "上下文視窗 Tokens",
        ...
        ["HunyuanModel_hy3"] = "混元 Hy3（TokenHub，256K）- 推薦",
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview（TokenHub，256K，2026-08-31 下線）",
        ["HunyuanModel_hy-mt2-pro"] = "混元 Hy-MT2 Pro（翻譯，8K）",
        ["HunyuanModel_hy-mt2-plus"] = "混元 Hy-MT2 Plus（翻譯，8K）",
        ["HunyuanModel_hy-mt2-lite"] = "混元 Hy-MT2 Lite（翻譯，8K）",
        ["HunyuanModel_hunyuan-role-latest"] = "混元 Hy-Role Latest（角色扮演，32K）",
        ["HunyuanModel_hy-role"] = "混元 Hy-Role（角色扮演，32K）",
        ...
        ["IMManualMode"] = "手填憑證",
        ["IMScanMode"] = "掃碼授權",
        ["IMScanAuthorizeBtn"] = "掃碼授權",
        ["IMWaitingAuth"] = "等待授權…",
        ["IMAuthorizedStatus"] = "已授權",
        ["IMAuthFailedStatus"] = "授權失敗",
        ["IMAuthTimeoutStatus"] = "授權超時",
        ["IMRedirectBaseUrlLabel"] = "回調基礎地址",
        ["IMPublicCallbackHint"] = "該平台首次授權需公網 HTTPS 回調，請先設定內網穿透或公網地址",
        ["IMHelpTitle"] = "接入指南",
        ["IMHelpOfficialDoc"] = "官方文檔",
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Ollama 模型的上下文視窗 Token 容量，留空則自動偵測",
        ...
        ["HerdsmanEndpoint"] = "牧馬人推理引擎 API 端點 URL",
        ["HerdsmanModel"] = "牧馬人推理引擎使用的模型",
        ["HerdsmanContextWindowTokens"] = "牧馬人推理引擎模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["LongCatApiKey"] = "美團 LongCat 大模型 API 密鑰",
        ["LongCatEndpoint"] = "美團 LongCat 大模型 API 端點 URL",
        ["LongCatModel"] = "美團 LongCat 大模型使用的模型",
        ["LongCatContextWindowTokens"] = "LongCat 模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["QiniuAIApiKey"] = "七牛雲 AI 大模型推理服務 API 密鑰",
        ["QiniuAIEndpoint"] = "七牛雲 AI 大模型推理服務 API 端點 URL",
        ["QiniuAIModel"] = "七牛雲 AI 大模型推理服務使用的模型",
        ["QiniuAIContextWindowTokens"] = "七牛雲 AI 模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["DeepSeekApiKey"] = "DeepSeek API 密鑰",
        ["DeepSeekModel"] = "DeepSeek 使用的模型",
        ["DeepSeekEndpoint"] = "DeepSeek API 端點 URL",
        ["DeepSeekContextWindowTokens"] = "DeepSeek 模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["ZhipuApiKey"] = "智譜 GLM API 密鑰",
        ["ZhipuModel"] = "智譜 GLM 使用的模型",
        ["ZhipuEndpoint"] = "智譜 GLM API 端點 URL",
        ["ZhipuContextWindowTokens"] = "智譜模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["MoonshotApiKey"] = "月之暗面 Kimi API 密鑰",
        ["MoonshotModel"] = "月之暗面 Kimi 使用的模型",
        ["MoonshotEndpoint"] = "月之暗面 Kimi API 端點 URL",
        ["MoonshotContextWindowTokens"] = "月之暗面模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["SiliconFlowApiKey"] = "硅基流動 API 密鑰",
        ["SiliconFlowModel"] = "硅基流動使用的模型",
        ["SiliconFlowEndpoint"] = "硅基流動 API 端點 URL",
        ["SiliconFlowContextWindowTokens"] = "硅基流動模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["MiniMaxApiKey"] = "MiniMax API 密鑰",
        ["MiniMaxModel"] = "MiniMax 使用的模型",
        ["MiniMaxEndpoint"] = "MiniMax API 端點 URL",
        ["MiniMaxContextWindowTokens"] = "MiniMax 模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["ErnieApiKey"] = "百度文心 API 密鑰",
        ["ErnieModel"] = "百度文心使用的模型",
        ["ErnieEndpoint"] = "百度文心 API 端點 URL",
        ["ErnieContextWindowTokens"] = "文心模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["HunyuanApiKey"] = "騰訊混元 API 密鑰",
        ["HunyuanModel"] = "騰訊混元使用的模型",
        ["HunyuanEndpoint"] = "騰訊混元 API 端點 URL",
        ["HunyuanContextWindowTokens"] = "混元模型的上下文視窗 Token 容量，留空則回退到預設訊息條數限制",
        ["WebPort"] = "Web 伺服器連接埠",
        ["WebSkin"] = "Web 主題名稱",
        ...
        ["MaxContextMessages"] = "單次 AI 請求載入上下文的最近聊天記錄條數上限（模型未上報上下文窗口大小時作為回退窗口使用）",
    ...
    public override string GetBeingActivityName(BeingActivity activity) => activity switch
    {
        ...
        BeingActivity.Broadcast => "處理廣播",
        BeingActivity.Project => "項目工作中",
    ...
    public override string CalendarChineseHistoricalName => "中國歷史紀年曆";
    ...
    private readonly ChineseHistoricalZhHK _chineseHistorical = new();
    ...
    public override string ProjectCtx_ProjectInfoHeader => "項目歸屬";
    public override string ProjectCtx_ProjectInfoRoleLabel => "角色";
    ...
    public override string ProjectCtx_RoleNeedsAttention => "⚠ 有{0}個角色人員不足，需要建立硅基人並分配角色";
    public override string ProjectCtx_StaffingActionPlanHeader => "人員配備行動計劃";
    public override string ProjectCtx_TotalBeingsNeeded => "需要建立的硅基人總數：{0}";
    public override string ProjectCtx_StaffingRoleBreakdownHeader => "各角色人員缺口明細";
    public override string ProjectCtx_RoleShortageDetail => "{0}：需{1}人，已有{2}人 → 缺{3}人";
    public override string ProjectCtx_StaffingActionStepsHeader => "建議操作步驟";
    public override string ProjectCtx_StaffingStepCreateBeings => "1. 使用 silicon_manager 的 create_being 建立 {0} 個硅基人（每個角色至少1人）";
    public override string ProjectCtx_StaffingStepAssignToProject => "2. 使用 project 的 assign 將新建的硅基人加入專案";
    public override string ProjectCtx_StaffingStepAssignToRoles => "3. 使用 project 的 assign_role 將每個硅基人分配到對應的角色";
    public override string ProjectCtx_EmptyRolePoolAction => "⚠ 角色池為空！工作流定義了{0}個角色，需要建立硅基人並逐一分配到各角色";
    ...
    public override string ProjectCtx_AvailableBeingsHeader => "可用矽基人（尚未分配到本項目）";
    public override string ProjectCtx_AvailableBeingsHint => "提示：優先將已有矽基人分配到角色，而非建立新的。使用 project assign 和 project assign_role。";
    ...
    public override string WorkflowRoleBlockedNotificationFormat => "[工作流角色通知] 項目「{0}」的工作流在轉移「{1}」（{2} → {3}）時被阻塞。\n\n缺失角色：{4}\n\n請使用 project_tool 的 assign_role 動作為項目分配所需角色，工作流將在下次檢查時自動恢復。";

    // ===== Project Think Session Localization =====
    public override string ProjectThinkHistoryLinkLabel => "處理記錄";
    public override string ProjectThinkHistoryTitle => "項目處理記錄";
    public override string ProjectThinkHistoryHeader => "處理記錄";
    public override string ProjectThinkBackToProjects => "← 返回項目列表";
    public override string ProjectThinkProjectName => "項目：{0}";
    public override string ProjectThinkNoRecords => "暫無處理記錄";
    public override string ProjectThinkStateStarted => "已啟動";
    public override string ProjectThinkStateExecuting => "執行中";
    public override string ProjectThinkStateCompleted => "已完成";
    public override string ProjectThinkStateFailed => "已失敗";
    public override string ProjectThinkDetailTitle => "處理詳情";
