...
public override string AboutFailedPluginListLabel => "Plugins que falharam ao carregar";
public override string GetSocialMediaName(string platform) => platform switch
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Tokens de janela de contexto",
        ...
        ["HerdsmanContextWindowTokens"] = "Tokens de janela de contexto",
        ["LongCatClient"] = "Cliente LongCat",
        ["LongCatApiKey"] = "Chave API",
        ["LongCatEndpoint"] = "Endpoint LongCat",
        ["LongCatModel"] = "Modelo",
        ["LongCatContextWindowTokens"] = "Tokens de janela de contexto",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0 (1M contexto, 128K saída, Agentic) - Recomendado",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat (Legado, 128K)",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat (Legado, 128K)",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat (Legado, 128K)",
        ["QiniuAIClient"] = "Cliente Qiniu AI",
        ["QiniuAIApiKey"] = "Chave API",
        ["QiniuAIEndpoint"] = "Endpoint Qiniu AI",
        ["QiniuAIModel"] = "Modelo",
        ["QiniuAIContextWindowTokens"] = "Tokens de janela de contexto",
        ["DeepSeekClient"] = "Cliente DeepSeek",
        ["DeepSeekApiKey"] = "Chave API",
        ["DeepSeekModel"] = "Modelo",
        ["DeepSeekEndpoint"] = "Endpoint",
        ["DeepSeekContextWindowTokens"] = "Tokens de janela de contexto",
        ["ZhipuClient"] = "Cliente Zhipu",
        ["ZhipuApiKey"] = "Chave API",
        ["ZhipuModel"] = "Modelo",
        ["ZhipuEndpoint"] = "Endpoint",
        ["ZhipuContextWindowTokens"] = "Tokens de janela de contexto",
        ["MoonshotClient"] = "Cliente Moonshot",
        ["MoonshotApiKey"] = "Chave API",
        ["MoonshotModel"] = "Modelo",
        ["MoonshotEndpoint"] = "Endpoint",
        ["MoonshotContextWindowTokens"] = "Tokens de janela de contexto",
        ["SiliconFlowClient"] = "Cliente SiliconFlow",
        ["SiliconFlowApiKey"] = "Chave API",
        ["SiliconFlowModel"] = "Modelo",
        ["SiliconFlowEndpoint"] = "Endpoint",
        ["SiliconFlowContextWindowTokens"] = "Tokens de janela de contexto",
        ["MiniMaxClient"] = "Cliente MiniMax",
        ["MiniMaxApiKey"] = "Chave API",
        ["MiniMaxModel"] = "Modelo",
        ["MiniMaxEndpoint"] = "Endpoint",
        ["MiniMaxContextWindowTokens"] = "Tokens de janela de contexto",
        ["ErnieClient"] = "Cliente Ernie",
        ["ErnieApiKey"] = "Chave API",
        ["ErnieModel"] = "Modelo",
        ["ErnieEndpoint"] = "Endpoint",
        ["ErnieContextWindowTokens"] = "Tokens de janela de contexto",
        ["HunyuanClient"] = "Cliente Hunyuan",
        ["HunyuanApiKey"] = "Chave API",
        ["HunyuanModel"] = "Modelo",
        ["HunyuanEndpoint"] = "Endpoint",
        ["HunyuanContextWindowTokens"] = "Tokens de janela de contexto",
        ...
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, descontinuado em 31/08/2026)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro (Tradução, 8K)",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus (Tradução, 8K)",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite (Tradução, 8K)",
        ["HunyuanModel_hunyuan-role-latest"] = "Hy Role Latest (Interpretação de papéis, 32K)",
        ["HunyuanModel_hy-role"] = "Hy Role (Interpretação de papéis, 32K)",
        ...
        ["MaxContextMessages"] = "Máximo de mensagens de contexto",
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos Ollama, deixar vazio para deteção automática",
        ...
        ["HerdsmanEndpoint"] = "URL do endpoint API do motor de inferência Herdsman",
        ["HerdsmanModel"] = "Modelo utilizado pelo motor de inferência Herdsman",
        ["HerdsmanContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos Herdsman, deixar vazio para reverter ao limite de mensagens predefinido",
        ["LongCatApiKey"] = "Chave API do modelo grande LongCat da Meituan",
        ["LongCatEndpoint"] = "URL do endpoint API do modelo grande LongCat da Meituan",
        ["LongCatModel"] = "Modelo a utilizar do modelo grande LongCat da Meituan",
        ["LongCatContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos LongCat, deixar vazio para reverter ao limite de mensagens predefinido",
        ["QiniuAIApiKey"] = "Chave API do serviço de inferência de modelo grande Qiniu Cloud AI",
        ["QiniuAIEndpoint"] = "URL do endpoint API do serviço de inferência de modelo grande Qiniu Cloud AI",
        ["QiniuAIModel"] = "Modelo a utilizar do serviço de inferência de modelo grande Qiniu Cloud AI",
        ["QiniuAIContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos Qiniu AI, deixar vazio para reverter ao limite de mensagens predefinido",
        ["DeepSeekApiKey"] = "Chave API do DeepSeek",
        ["DeepSeekModel"] = "Modelo DeepSeek a utilizar",
        ["DeepSeekEndpoint"] = "URL do endpoint da API DeepSeek",
        ["DeepSeekContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos DeepSeek, deixar vazio para reverter ao limite de mensagens predefinido",
        ["ZhipuApiKey"] = "Chave API do Zhipu GLM",
        ["ZhipuModel"] = "Modelo Zhipu GLM a utilizar",
        ["ZhipuEndpoint"] = "URL do endpoint da API Zhipu GLM",
        ["ZhipuContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos Zhipu, deixar vazio para reverter ao limite de mensagens predefinido",
        ["MoonshotApiKey"] = "Chave API do Moonshot Kimi",
        ["MoonshotModel"] = "Modelo Moonshot Kimi a utilizar",
        ["MoonshotEndpoint"] = "URL do endpoint da API Moonshot Kimi",
        ["MoonshotContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos Moonshot, deixar vazio para reverter ao limite de mensagens predefinido",
        ["SiliconFlowApiKey"] = "Chave API do SiliconFlow",
        ["SiliconFlowModel"] = "Modelo SiliconFlow a utilizar",
        ["SiliconFlowEndpoint"] = "URL do endpoint da API SiliconFlow",
        ["SiliconFlowContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos SiliconFlow, deixar vazio para reverter ao limite de mensagens predefinido",
        ["MiniMaxApiKey"] = "Chave API do MiniMax",
        ["MiniMaxModel"] = "Modelo MiniMax a utilizar",
        ["MiniMaxEndpoint"] = "URL do endpoint da API MiniMax",
        ["MiniMaxContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos MiniMax, deixar vazio para reverter ao limite de mensagens predefinido",
        ["ErnieApiKey"] = "Chave API do Baidu Ernie",
        ["ErnieModel"] = "Modelo Baidu Ernie a utilizar",
        ["ErnieEndpoint"] = "URL do endpoint da API Baidu Ernie",
        ["ErnieContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos Ernie, deixar vazio para reverter ao limite de mensagens predefinido",
        ["HunyuanApiKey"] = "Chave API do Tencent Hunyuan",
        ["HunyuanModel"] = "Modelo Tencent Hunyuan a utilizar",
        ["HunyuanEndpoint"] = "URL do endpoint da API Tencent Hunyuan",
        ["HunyuanContextWindowTokens"] = "Capacidade de tokens de janela de contexto para modelos Hunyuan, deixar vazio para reverter ao limite de mensagens predefinido",
        ...
        ["MaxContextMessages"] = "Número máximo de mensagens de chat recentes carregadas para o contexto por pedido de IA (usado como janela de recurso quando o modelo não reporta o tamanho da janela de contexto)",
...
Uso: Chama a ferramenta chat, define action=""mark_read"", target_id=GUID do interlocutor, sem parâmetro message necessário.";
    ...
    public override string ProjectThinkHistoryLinkLabel => "Histórico de processamento";
    public override string ProjectThinkHistoryTitle => "Histórico de processamento do projeto";
    public override string ProjectThinkHistoryHeader => "Histórico de processamento";
    public override string ProjectThinkBackToProjects => "← Voltar aos projetos";
    public override string ProjectThinkProjectName => "Projeto: {0}";
    public override string ProjectThinkNoRecords => "Sem sessões de processamento";
    public override string ProjectThinkStateStarted => "Iniciado";
    public override string ProjectThinkStateExecuting => "Em execução";
    public override string ProjectThinkStateCompleted => "Concluído";
    public override string ProjectThinkStateFailed => "Falhado";
    public override string ProjectThinkDetailTitle => "Detalhe da sessão";
    ...
    public override string ProjectThinkRoundN => "Rodada {0}";
}
