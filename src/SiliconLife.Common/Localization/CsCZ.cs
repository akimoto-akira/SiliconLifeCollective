...
public override string WorkflowDetailInProgress => "Funkce detailu pracovního postupu ve vývoji...";
    ...
    public override string WorkflowDetailPageHeader => "Detail pracovního postupu";
    public override string WorkflowRoleAssignmentsHeader => "Přiřazení rolí";
    public override string WorkflowUnassignedBeingsHeader => "Nepřiřazená křemíková bytosti";
    public override string WorkflowNoUnassignedBeings => "Všechny křemíkové bytosti jsou přiřazeny k rolím";
    public override string WorkflowStateTransitionsHeader => "Přechody stavů úkolů";
    public override string WorkflowNoTemplateMessage => "Tento projekt nemá přiřazenou šablonu pracovního postupu";
    public override string WorkflowNoRoleDefinitions => "Tato šablona pracovního postupu nedefinuje žádné role";
    public override string WorkflowNoTransitions => "Tato šablona pracovního postupu nedefinuje žádné přechody stavů";
    public override string WorkflowRoleAssignedCountLabel => "Přiřazeno";
    public override string WorkflowRoleRequiredCountLabel => "Vyžadováno";
    public override string WorkflowTransitionFromLabel => "Z";
    public override string WorkflowTransitionToLabel => "Do";
    public override string WorkflowAssignRoleButton => "Přiřadit roli";
    public override string WorkflowRemoveFromRoleButton => "Odebrat";
    public override string WorkflowTerminalStateLabel => "Koncový";
    public override string WorkflowInitialStateLabel => "Počáteční";
    ...
    private static readonly Dictionary<string, string> ConfigGroupNames = new()
    {
        ...
        ["Runtime"] = "Nastavení běhového prostředí",
        ["AI"] = "Nastavení AI",
    ...
    {
        ["DataDirectory"] = "Datový adresář",
        ["Language"] = "Jazyk",
        ["TickTimeout"] = "Časový limit tiku",
        ["MaxTimeoutCount"] = "Max. počet vypršení limitu",
        ["WatchdogTimeout"] = "Časový limit watchdogu",
        ["MinLogLevel"] = "Min. úroveň logování",
        ["AIClientType"] = "Typ AI klienta",
        ["OllamaClient"] = "Klient Ollama",
        ["OllamaEndpoint"] = "Koncový bod Ollama",
        ["DefaultModel"] = "Výchozí model",
        ["Temperature"] = "Teplota",
        ["MaxTokens"] = "Max. počet tokenů",
        ["OllamaContextWindowTokens"] = "Tokeny kontextového okna",
        ["DashScopeClient"] = "Klient DashScope",
        ["DashScopeApiKey"] = "API klíč",
        ["DashScopeRegion"] = "Region",
        ["DashScopeModel"] = "Model",
        ["DashScopeRegionBeijing"] = "Severní Čína 2 (Peking)",
        ["DashScopeRegionVirginia"] = "USA (Virginie)",
        ["DashScopeRegionSingapore"] = "Singapur",
        ["DashScopeRegionHongkong"] = "Hongkong (Čína)",
        ["DashScopeRegionFrankfurt"] = "Německo (Frankfurt)",
        ["DashScopeModel_qwen3-max"] = "Qwen3 Max (vlajková loď)",
        ["DashScopeModel_qwen3.6-plus"] = "Qwen3.6 Plus (vyvážený)",
        ["DashScopeModel_qwen3.6-flash"] = "Qwen3.6 Flash (rychlý)",
        ["DashScopeModel_qwen-max"] = "Qwen Max (stabilní vlajková loď)",
        ["DashScopeModel_qwen-plus"] = "Qwen Plus (stabilní vyvážený)",
        ["DashScopeModel_qwen-turbo"] = "Qwen Turbo (stabilní rychlý)",
        ["DashScopeModel_qwen3-coder-plus"] = "Qwen3 Coder Plus (kód)",
        ["DashScopeModel_qwq-plus"] = "QwQ Plus (hluboké uvažování)",
        ["DashScopeModel_deepseek-v3.2"] = "DeepSeek V3.2",
        ["DashScopeModel_deepseek-r1"] = "DeepSeek R1 (uvažování)",
        ["DashScopeModel_glm-5.1"] = "GLM 5.1 (Zhipu)",
        ["DashScopeModel_kimi-k2.5"] = "Kimi K2.5 (dlouhý kontext)",
        ["DashScopeModel_llama-4-maverick"] = "Llama 4 Maverick",
        ["VolcengineArkClient"] = "Klient Volcengine Ark",
        ["VolcengineArkApiKey"] = "API klíč",
        ["VolcengineArkEndpointId"] = "ID inferenčního koncového bodu",
        ["HerdsmanClient"] = "Klient Herdsman",
        ["HerdsmanEndpoint"] = "Koncový bod Herdsman",
        ["HerdsmanModel"] = "Model",
        ["HerdsmanContextWindowTokens"] = "Tokeny kontextového okna",
        ["LongCatClient"] = "Klient LongCat",
        ["LongCatApiKey"] = "API klíč",
        ["LongCatEndpoint"] = "Koncový bod LongCat",
        ["LongCatModel"] = "Model",
        ["LongCatContextWindowTokens"] = "Tokeny kontextového okna",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0 (1M kontext, 128K výstup, Agentic) - Doporučeno",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat (Starší, 128K)",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat (Starší, 128K)",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat (Starší, 128K)",
        ["QiniuAIClient"] = "Klient Qiniu AI",
        ["QiniuAIApiKey"] = "API klíč",
        ["QiniuAIEndpoint"] = "Koncový bod Qiniu AI",
        ["QiniuAIModel"] = "Model",
        ["QiniuAIContextWindowTokens"] = "Tokeny kontextového okna",
        ["DeepSeekClient"] = "Klient DeepSeek",
        ["DeepSeekApiKey"] = "API klíč",
        ["DeepSeekModel"] = "Model",
        ["DeepSeekEndpoint"] = "Koncový bod",
        ["DeepSeekContextWindowTokens"] = "Tokeny kontextového okna",
        ["ZhipuClient"] = "Klient Zhipu",
        ["ZhipuApiKey"] = "API klíč",
        ["ZhipuModel"] = "Model",
        ["ZhipuEndpoint"] = "Koncový bod",
        ["ZhipuContextWindowTokens"] = "Tokeny kontextového okna",
        ["MoonshotClient"] = "Klient Moonshot",
        ["MoonshotApiKey"] = "API klíč",
        ["MoonshotModel"] = "Model",
        ["MoonshotEndpoint"] = "Koncový bod",
        ["MoonshotContextWindowTokens"] = "Tokeny kontextového okna",
        ["SiliconFlowClient"] = "Klient SiliconFlow",
        ["SiliconFlowApiKey"] = "API klíč",
        ["SiliconFlowModel"] = "Model",
        ["SiliconFlowEndpoint"] = "Koncový bod",
        ["SiliconFlowContextWindowTokens"] = "Tokeny kontextového okna",
        ["MiniMaxClient"] = "Klient MiniMax",
        ["MiniMaxApiKey"] = "API klíč",
        ["MiniMaxModel"] = "Model",
        ["MiniMaxEndpoint"] = "Koncový bod",
        ["MiniMaxContextWindowTokens"] = "Tokeny kontextového okna",
        ["ErnieClient"] = "Klient Ernie",
        ["ErnieApiKey"] = "API klíč",
        ["ErnieModel"] = "Model",
        ["ErnieEndpoint"] = "Koncový bod",
        ["ErnieContextWindowTokens"] = "Tokeny kontextového okna",
        ["HunyuanClient"] = "Klient Hunyuan",
        ["HunyuanApiKey"] = "API klíč",
        ["HunyuanModel"] = "Model",
        ["HunyuanEndpoint"] = "Koncový bod",
        ["HunyuanContextWindowTokens"] = "Tokeny kontextového okna",
        ["DeepSeekModel_deepseek-v4-flash"] = "DeepSeek V4 Flash (kontext 1M, vysoká rychlost)",
        ["DeepSeekModel_deepseek-v4-pro"] = "DeepSeek V4 Pro (kontext 1M, vlajkové uvažování)",
        ["ZhipuModel_glm-4-flash"] = "GLM-4-Flash (zdarma, 128K) — doporučeno pro ladění",
        ["ZhipuModel_glm-4.7-flash"] = "GLM-4.7-Flash (zdarma, 200K)",
        ...
        ["ZhipuModel_glm-4-long"] = "GLM-4-Long (1 CNY/M, kontext 1M)",
        ["ZhipuModel_glm-4.6"] = "GLM-4.6 (vlajková loď, 200K)",
        ["ZhipuModel_glm-4.7"] = "GLM-4.7 (vlajková loď, 200K)",
        ["ZhipuModel_glm-5"] = "GLM-5 (kódovací agent, 128K)",
        ["ZhipuModel_glm-5.1"] = "GLM-5.1 (agent s dlouhým dosahem, 128K)",
        ["MoonshotModel_kimi-k2.6"] = "Kimi K2.6 (vlajková loď, 256K, multimodální) — doporučeno",
        ["MoonshotModel_kimi-k2.5"] = "Kimi K2.5 (cenově výhodná vlajková loď, 256K)",
        ["MoonshotModel_kimi-k2.7-code"] = "Kimi K2.7 Code (kódování, 256K, vynucené myšlení)",
        ...
        ["MiniMaxModel_MiniMax-M3"] = "MiniMax M3 (vlajková loď, kontext 1M, multimodální) — doporučeno",
        ["MiniMaxModel_MiniMax-M2.7"] = "MiniMax M2.7 (192K, kód/agent)",
        ...
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview (TokenHub, 256K, ukončení 31. 8. 2026)",
        ["HunyuanModel_hy-mt2-pro"] = "Hy-MT2 Pro (překlad, 8K)",
        ["HunyuanModel_hy-mt2-plus"] = "Hy-MT2 Plus (překlad, 8K)",
        ["HunyuanModel_hy-mt2-lite"] = "Hy-MT2 Lite (překlad, 8K)",
        ["HunyuanModel_hunyuan-role-latest"] = "Hy Role Latest (roleplay, 32K)",
        ["HunyuanModel_hy-role"] = "Hy Role (roleplay, 32K)",
        ...
        ["WebPort"] = "Webový port",
        ["WebSkin"] = "Vzhled webu",
        ["UserNickname"] = "Přezdívka uživatele",
        ["PluginDirectories"] = "Adresáře pluginů",
        ["IMPlatforms"] = "IM platformy",
        ["IMAddPlatform"] = "Přidat platformu",
        ["IMPlatformType"] = "Typ platformy",
        ["IMEnabledLabel"] = "Povoleno",
        ["IMDeleteLabel"] = "Smazat",
        ["IMAuthModeLabel"] = "Režim autorizace",
        ["IMManualMode"] = "Ruční zadání přihlašovacích údajů",
        ["IMScanMode"] = "Autorizace naskenováním",
        ["IMScanAuthorizeBtn"] = "Autorizovat naskenováním",
        ["IMWaitingAuth"] = "Čekání na autorizaci…",
        ["IMAuthorizedStatus"] = "Autorizováno",
        ["IMAuthFailedStatus"] = "Autorizace se nezdařila",
        ["IMAuthTimeoutStatus"] = "Časový limit autorizace vypršel",
        ["IMRedirectBaseUrlLabel"] = "Základní URL zpětného volání",
        ["IMPublicCallbackHint"] = "Tato platforma vyžaduje pro první autorizaci veřejné HTTPS zpětné volání; nejprve nakonfigurujte tunel nebo veřejnou adresu",
        ["IMHelpTitle"] = "Průvodce nastavením",
        ["IMHelpOfficialDoc"] = "Oficiální dokumentace",
        ...
        ["MaxContextMessages"] = "Maximum zpráv kontextu",
    ...
    {
        ["DataDirectory"] = "Cesta k datovému adresáři pro ukládání všech dat aplikace",
        ["Language"] = "Jazykové nastavení aplikace",
        ["TickTimeout"] = "Doba časového limitu pro provedení každého tiku",
        ["MaxTimeoutCount"] = "Maximální počet po sobě jdoucích vypršení limitu před aktivací pojistky",
        ["WatchdogTimeout"] = "Časový limit watchdogu pro detekci zamrzlé hlavní smyčky",
        ["MinLogLevel"] = "Globální minimální úroveň logování",
        ["AIClientType"] = "Typ AI klienta, který se má použít",
        ["OllamaEndpoint"] = "URL koncového bodu API Ollama",
        ["DefaultModel"] = "Výchozí AI model, který se má použít",
        ["OllamaContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely Ollama; ponechte prázdné pro automatickou detekci",
        ["DashScopeApiKey"] = "API klíč Alibaba Cloud DashScope",
        ["DashScopeRegion"] = "Region služby Alibaba Cloud DashScope",
        ["DashScopeModel"] = "Model Alibaba Cloud DashScope, který se má použít",
        ["VolcengineArkApiKey"] = "API klíč Volcengine Ark",
        ["VolcengineArkEndpointId"] = "ID inferenčního koncového bodu Volcengine Ark",
        ["HerdsmanEndpoint"] = "URL koncového bodu API inferenčního enginu Herdsman",
        ["HerdsmanModel"] = "Model inferenčního enginu Herdsman, který se má použít",
        ["HerdsmanContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely Herdsman; ponechte prázdné pro výchozí limit zpráv",
        ["LongCatApiKey"] = "API klíč velkého modelu Meituan LongCat",
        ["LongCatEndpoint"] = "URL koncového bodu API velkého modelu Meituan LongCat",
        ["LongCatModel"] = "Velký model Meituan LongCat, který se má použít",
        ["LongCatContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely LongCat; ponechte prázdné pro výchozí limit zpráv",
        ["QiniuAIApiKey"] = "API klíč inferenční služby velkých modelů Qiniu Cloud AI",
        ["QiniuAIEndpoint"] = "URL koncového bodu API inferenční služby velkých modelů Qiniu Cloud AI",
        ["QiniuAIModel"] = "Model inferenční služby velkých modelů Qiniu Cloud AI, který se má použít",
        ["QiniuAIContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely Qiniu AI; ponechte prázdné pro výchozí limit zpráv",
        ["DeepSeekApiKey"] = "API klíč DeepSeek",
        ["DeepSeekModel"] = "Model DeepSeek, který se má použít",
        ["DeepSeekEndpoint"] = "URL koncového bodu API DeepSeek",
        ["DeepSeekContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely DeepSeek; ponechte prázdné pro výchozí limit zpráv",
        ["ZhipuApiKey"] = "API klíč Zhipu GLM",
        ["ZhipuModel"] = "Model Zhipu GLM, který se má použít",
        ["ZhipuEndpoint"] = "URL koncového bodu API Zhipu GLM",
        ["ZhipuContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely Zhipu; ponechte prázdné pro výchozí limit zpráv",
        ["MoonshotApiKey"] = "API klíč Moonshot Kimi",
        ["MoonshotModel"] = "Model Moonshot Kimi, který se má použít",
        ["MoonshotEndpoint"] = "URL koncového bodu API Moonshot Kimi",
        ["MoonshotContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely Moonshot; ponechte prázdné pro výchozí limit zpráv",
        ["SiliconFlowApiKey"] = "API klíč SiliconFlow",
        ["SiliconFlowModel"] = "Model SiliconFlow, který se má použít",
        ["SiliconFlowEndpoint"] = "URL koncového bodu API SiliconFlow",
        ["SiliconFlowContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely SiliconFlow; ponechte prázdné pro výchozí limit zpráv",
        ["MiniMaxApiKey"] = "API klíč MiniMax",
        ["MiniMaxModel"] = "Model MiniMax, který se má použít",
        ["MiniMaxEndpoint"] = "URL koncového bodu API MiniMax",
        ["MiniMaxContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely MiniMax; ponechte prázdné pro výchozí limit zpráv",
        ["ErnieApiKey"] = "API klíč Baidu Ernie",
        ["ErnieModel"] = "Model Baidu Ernie, který se má použít",
        ["ErnieEndpoint"] = "URL koncového bodu API Baidu Ernie",
        ["ErnieContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely Ernie; ponechte prázdné pro výchozí limit zpráv",
        ["HunyuanApiKey"] = "API klíč Tencent Hunyuan",
        ["HunyuanModel"] = "Model Tencent Hunyuan, který se má použít",
        ["HunyuanEndpoint"] = "URL koncového bodu API Tencent Hunyuan",
        ["HunyuanContextWindowTokens"] = "Kapacita kontextového okna v tokenech pro modely Hunyuan; ponechte prázdné pro výchozí limit zpráv",
        ["WebPort"] = "Port webového serveru",
        ...
        ["MaxContextMessages"] = "Maximální počet nedávných zpráv chatu načítaných do kontextu na AI požadavek (používá se jako záložní okno, když model nehlásí velikost kontextového okna)",
    ...
    public override string GetBeingActivityName(BeingActivity activity) => activity switch
    {
        ...
        BeingActivity.Broadcast => "Zpracování broadcastu",
        BeingActivity.Project => "Práce na projektu",
    ...
    public override string ProjectCtx_RoleNeedsAttention => "⚠ {0} role(í) má nedostatek personálu. Musíte vytvořit křemíkové bytosti a přiřadit je k rolím";
    public override string ProjectCtx_StaffingActionPlanHeader => "Akční plán personálního obsazení";
    public override string ProjectCtx_TotalBeingsNeeded => "Celkový počet křemíkových bytostí k vytvoření: {0}";
    public override string ProjectCtx_StaffingRoleBreakdownHeader => "Detail nedostatku personálu podle rolí";
    public override string ProjectCtx_RoleShortageDetail => "{0}: potřeba {1}, aktuálně {2} → chybí {3}";
    public override string ProjectCtx_StaffingActionStepsHeader => "Navrhované kroky";
    public override string ProjectCtx_StaffingStepCreateBeings => "1. Použijte silicon_manager create_being k vytvoření {0} křemíkových bytostí (minimálně 1 pro každou roli)";
    public override string ProjectCtx_StaffingStepAssignToProject => "2. Použijte project assign k přidání nových bytostí do projektu";
    public override string ProjectCtx_StaffingStepAssignToRoles => "3. Použijte project assign_role k přiřazení každé bytosti k odpovídající roli";
    public override string ProjectCtx_EmptyRolePoolAction => "⚠ Fond rolí je prázdný! Workflow definuje {0} rolí. Vytvořte křemíkové bytosti a přiřaďte je k jednotlivým rolím";
    ...
    public override string ProjectCtx_AvailableBeingsHeader => "Dostupné bytosti (ještě nepřiřazené k tomuto projektu)";
    public override string ProjectCtx_AvailableBeingsHint => "Tip: Zvažte přiřazení stávajících bytostí k rolím před vytvořením nových. Použijte project assign a project assign_role.";
