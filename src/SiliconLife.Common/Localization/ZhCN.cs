...
public override string GetSocialMediaName(string platform) => platform switch
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["HunyuanModel_hunyuan-turbos-latest"] = "混元 TurboS（128K）",
        ["HunyuanModel_hunyuan-t1-latest"] = "混元 T1（256K）",
        ["HunyuanModel_hunyuan-a13b"] = "混元 A13B（轻量级）",
        ["HunyuanModel_hunyuan-functioncall"] = "混元 FunctionCall（工具调用）",
