...
使用方法：调用 chat 工具，设置 action=""mark_read""，target_id=对方GUID，无需 message 参数。";
    ...
    public override string InitFooterHint => "配置完成后可随时在设置页面修改";
        public override string InitHelpLink => "📖 查看帮助文档";
        public override string InitAIClientHelpPrefix => "📖 查看帮助：";
    ...
    public override string MemoryTimelineEmptyState => "暂无记忆数据";
    public override string MemoryYearSummaryLabel => "年度总结";
    public override string MemoryMonthSummaryLabel => "月度总结";
    public override string MemoryDaySummaryLabel => "日总结";
    public override string MemoryHourSummaryLabel => "时段总结";
    public override string MemoryMinuteSummaryLabel => "分钟总结";
    public override string MemorySummaryBadge => "压缩总结";
    public override string MemoryTimelineYearFormat => "{0}年 ({1}条)";
    public override string MemoryTimelineMonthFormat => "{0}年{1}月 ({2}条)";
    public override string MemoryTimelineDayFormat => "{0}-{1}-{2} ({3}条)";
    public override string MemoryTimelineHourFormat => "{0}:00 ({1}条)";
    public override string MemoryTimelineMinuteFormat => "{0}:{1} ({2}条)";
    public override string MemoryRelatedBeingsLabel => "👥 关联: {0} 个智能体";
    ...
    public override string WorkflowDetailPageHeader => "工作流详情";
    public override string WorkflowRoleAssignmentsHeader => "角色分配";
    public override string WorkflowUnassignedBeingsHeader => "未分配角色的硅基人";
    public override string WorkflowNoUnassignedBeings => "所有硅基人均已分配角色";
    public override string WorkflowStateTransitionsHeader => "任务状态流转";
    public override string WorkflowNoTemplateMessage => "该项目未关联工作流模板";
    public override string WorkflowNoRoleDefinitions => "该工作流模板未定义角色";
    public override string WorkflowNoTransitions => "该工作流模板未定义状态转换";
    public override string WorkflowRoleAssignedCountLabel => "已分配";
    public override string WorkflowRoleRequiredCountLabel => "需要";
    public override string WorkflowTransitionFromLabel => "从";
    ...
    public override string WorkflowTerminalStateLabel => "终态";
    public override string WorkflowInitialStateLabel => "初始状态";
    ...
    public override string ChatLoading => "正在加载...";
...
public override string AboutFailedPluginListLabel => "加载失败的插件";
public override string GetSocialMediaName(string platform) => platform switch
    ...
    private static readonly Dictionary<string, string> ConfigDisplayNames = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "上下文窗口 Tokens",
        ...
        ["HerdsmanClient"] = "牧马人推理引擎客户端",
        ["HerdsmanEndpoint"] = "牧马人端点",
        ["HerdsmanModel"] = "模型",
        ["HerdsmanContextWindowTokens"] = "上下文窗口 Tokens",
        ["LongCatClient"] = "LongCat 客户端",
        ["LongCatApiKey"] = "API 密钥",
        ["LongCatEndpoint"] = "LongCat 端点",
        ["LongCatModel"] = "模型",
        ["LongCatContextWindowTokens"] = "上下文窗口 Tokens",
        ["LongCatModel_LongCat-2.0"] = "LongCat-2.0（1M 上下文，128K 输出，Agentic）- 推荐",
        ["LongCatModel_LongCat-Flash-Chat"] = "LongCat Flash Chat（旧版，128K）",
        ["LongCatModel_LongCat-Pro-Chat"] = "LongCat Pro Chat（旧版，128K）",
        ["LongCatModel_LongCat-Max-Chat"] = "LongCat Max Chat（旧版，128K）",
        ["QiniuAIClient"] = "七牛云 AI 客户端",
        ["QiniuAIApiKey"] = "API 密钥",
        ["QiniuAIEndpoint"] = "七牛云端点",
        ["QiniuAIModel"] = "模型",
        ["QiniuAIContextWindowTokens"] = "上下文窗口 Tokens",
        ["DeepSeekClient"] = "DeepSeek 客户端",
        ["DeepSeekApiKey"] = "API 密钥",
        ["DeepSeekModel"] = "模型",
        ["DeepSeekEndpoint"] = "端点",
        ["DeepSeekContextWindowTokens"] = "上下文窗口 Tokens",
        ["ZhipuClient"] = "智谱客户端",
        ["ZhipuApiKey"] = "API 密钥",
        ["ZhipuModel"] = "模型",
        ["ZhipuEndpoint"] = "端点",
        ["ZhipuContextWindowTokens"] = "上下文窗口 Tokens",
        ["MoonshotClient"] = "月之暗面客户端",
        ["MoonshotApiKey"] = "API 密钥",
        ["MoonshotModel"] = "模型",
        ["MoonshotEndpoint"] = "端点",
        ["MoonshotContextWindowTokens"] = "上下文窗口 Tokens",
        ["SiliconFlowClient"] = "硅基流动客户端",
        ["SiliconFlowApiKey"] = "API 密钥",
        ["SiliconFlowModel"] = "模型",
        ["SiliconFlowEndpoint"] = "端点",
        ["SiliconFlowContextWindowTokens"] = "上下文窗口 Tokens",
        ["MiniMaxClient"] = "MiniMax 客户端",
        ["MiniMaxApiKey"] = "API 密钥",
        ["MiniMaxModel"] = "模型",
        ["MiniMaxEndpoint"] = "端点",
        ["MiniMaxContextWindowTokens"] = "上下文窗口 Tokens",
        ["ErnieClient"] = "文心客户端",
        ["ErnieApiKey"] = "API 密钥",
        ["ErnieModel"] = "模型",
        ["ErnieEndpoint"] = "端点",
        ["ErnieContextWindowTokens"] = "上下文窗口 Tokens",
        ["HunyuanClient"] = "混元客户端",
        ["HunyuanApiKey"] = "API 密钥",
        ["HunyuanModel"] = "模型",
        ["HunyuanEndpoint"] = "端点",
        ["HunyuanContextWindowTokens"] = "上下文窗口 Tokens",
        ["DeepSeekModel_deepseek-v4-flash"] = "DeepSeek V4 Flash（1M 上下文，高速）",
        ["DeepSeekModel_deepseek-v4-pro"] = "DeepSeek V4 Pro（1M 上下文，旗舰推理）",
        ["ZhipuModel_glm-4-flash"] = "GLM-4-Flash（免费，128K）- 调试推荐",
        ["ZhipuModel_glm-4.7-flash"] = "GLM-4.7-Flash（免费，200K）",
        ["ZhipuModel_glm-4-air"] = "GLM-4-Air（0.5元/M，128K）",
        ["ZhipuModel_glm-4-flashx"] = "GLM-4-FlashX（0.1元/M，128K）",
        ["ZhipuModel_glm-4-plus"] = "GLM-4-Plus（5元/M，128K）",
        ["ZhipuModel_glm-4-long"] = "GLM-4-Long（1元/M，1M 上下文）",
        ["ZhipuModel_glm-4.6"] = "GLM-4.6（旗舰，200K）",
        ["ZhipuModel_glm-4.7"] = "GLM-4.7（旗舰，200K）",
        ["ZhipuModel_glm-5"] = "GLM-5（代码 Agent，128K）",
        ["ZhipuModel_glm-5.1"] = "GLM-5.1（远程 Agent，128K）",
        ["MoonshotModel_kimi-k2.6"] = "Kimi K2.6（旗舰，256K，多模态）- 推荐",
        ["MoonshotModel_kimi-k2.5"] = "Kimi K2.5（性价比旗舰，256K）",
        ["MoonshotModel_kimi-k2.7-code"] = "Kimi K2.7 Code（代码，256K，强制思考）",
        ...
        ["MiniMaxModel_MiniMax-M3"] = "MiniMax M3（旗舰，1M 上下文，多模态）- 推荐",
        ["MiniMaxModel_MiniMax-M2.7"] = "MiniMax M2.7（192K，代码/Agent）",
        ...
        ["HunyuanModel_hy3-preview"] = "Hy3 Preview（TokenHub，256K，2026-08-31 下线）",
        ["HunyuanModel_hy-mt2-pro"] = "混元 Hy-MT2 Pro（翻译，8K）",
        ["HunyuanModel_hy-mt2-plus"] = "混元 Hy-MT2 Plus（翻译，8K）",
        ["HunyuanModel_hy-mt2-lite"] = "混元 Hy-MT2 Lite（翻译，8K）",
    ...
    private static readonly Dictionary<string, string> ConfigDescriptions = new()
    {
        ...
        ["OllamaContextWindowTokens"] = "Ollama 模型的上下文窗口 Token 容量，留空则自动检测",
        ...
        ["HerdsmanEndpoint"] = "牧马人推理引擎 API 端点 URL",
        ["HerdsmanModel"] = "牧马人推理引擎使用的模型",
        ["HerdsmanContextWindowTokens"] = "牧马人推理引擎模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["LongCatApiKey"] = "美团 LongCat 大模型 API 密钥",
        ["LongCatEndpoint"] = "美团 LongCat 大模型 API 端点 URL",
        ["LongCatModel"] = "美团 LongCat 大模型使用的模型",
        ["LongCatContextWindowTokens"] = "LongCat 模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["QiniuAIApiKey"] = "七牛云 AI 大模型推理服务 API 密钥",
        ["QiniuAIEndpoint"] = "七牛云 AI 大模型推理服务 API 端点 URL",
        ["QiniuAIModel"] = "七牛云 AI 大模型推理服务使用的模型",
        ["QiniuAIContextWindowTokens"] = "七牛云 AI 模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["DeepSeekApiKey"] = "DeepSeek API 密钥",
        ["DeepSeekModel"] = "DeepSeek 使用的模型",
        ["DeepSeekEndpoint"] = "DeepSeek API 端点 URL",
        ["DeepSeekContextWindowTokens"] = "DeepSeek 模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["ZhipuApiKey"] = "智谱 GLM API 密钥",
        ["ZhipuModel"] = "智谱 GLM 使用的模型",
        ["ZhipuEndpoint"] = "智谱 GLM API 端点 URL",
        ["ZhipuContextWindowTokens"] = "智谱模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["MoonshotApiKey"] = "月之暗面 Kimi API 密钥",
        ["MoonshotModel"] = "月之暗面 Kimi 使用的模型",
        ["MoonshotEndpoint"] = "月之暗面 Kimi API 端点 URL",
        ["MoonshotContextWindowTokens"] = "月之暗面模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["SiliconFlowApiKey"] = "硅基流动 API 密钥",
        ["SiliconFlowModel"] = "硅基流动使用的模型",
        ["SiliconFlowEndpoint"] = "硅基流动 API 端点 URL",
        ["SiliconFlowContextWindowTokens"] = "硅基流动模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["MiniMaxApiKey"] = "MiniMax API 密钥",
        ["MiniMaxModel"] = "MiniMax 使用的模型",
        ["MiniMaxEndpoint"] = "MiniMax API 端点 URL",
        ["MiniMaxContextWindowTokens"] = "MiniMax 模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["ErnieApiKey"] = "百度文心 API 密钥",
        ["ErnieModel"] = "百度文心使用的模型",
        ["ErnieEndpoint"] = "百度文心 API 端点 URL",
        ["ErnieContextWindowTokens"] = "文心模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["HunyuanApiKey"] = "腾讯混元 API 密钥",
        ["HunyuanModel"] = "腾讯混元使用的模型",
        ["HunyuanEndpoint"] = "腾讯混元 API 端点 URL",
        ["HunyuanContextWindowTokens"] = "混元模型的上下文窗口 Token 容量，留空则回退到默认消息条数限制",
        ["WebPort"] = "Web 服务器端口",
        ["WebSkin"] = "Web 皮肤名称",
        ...
        ["MaxContextMessages"] = "单次 AI 请求载入上下文的最近聊天记录条数上限（模型未上报上下文窗口大小时作为回退窗口使用）",
    ...
    {
        BeingActivity.Idle => "空闲",
        BeingActivity.SingleChat => "单聊中",
        BeingActivity.GroupChat => "群聊中",
        BeingActivity.Task => "执行任务",
        BeingActivity.Timer => "执行定时任务",
        BeingActivity.Broadcast => "处理广播",
        BeingActivity.Project => "项目工作中",
    ...
    public override string ProjectCtx_ProjectInfoHeader => "项目归属";
    public override string ProjectCtx_ProjectInfoRoleLabel => "角色";
    public override string ProjectCtx_ProjectInfoGoalLabel => "目标";
    ...
    public override string ProjectCtx_RoleNeedsAttention => "⚠ 有{0}个角色人员不足，需要创建硅基人并分配角色";
    public override string ProjectCtx_StaffingActionPlanHeader => "人员配备行动计划";
    public override string ProjectCtx_TotalBeingsNeeded => "需要创建的硅基人总数：{0}";
    public override string ProjectCtx_StaffingRoleBreakdownHeader => "各角色人员缺口明细";
    public override string ProjectCtx_RoleShortageDetail => "{0}：需{1}人，已有{2}人 → 缺{3}人";
    public override string ProjectCtx_StaffingActionStepsHeader => "建议操作步骤";
    public override string ProjectCtx_StaffingStepCreateBeings => "1. 使用 silicon_manager 的 create_being 创建 {0} 个硅基人（每个角色至少1人）";
    public override string ProjectCtx_StaffingStepAssignToProject => "2. 使用 project 的 assign 将新创建的硅基人加入项目";
    public override string ProjectCtx_StaffingStepAssignToRoles => "3. 使用 project 的 assign_role 将每个硅基人分配到对应的角色";
    public override string ProjectCtx_EmptyRolePoolAction => "⚠ 角色池为空！工作流定义了{0}个角色，需要创建硅基人并逐一分配到各角色";
    ...
    public override string ProjectCtx_AvailableBeingsHeader => "可用硅基人（尚未分配到本项目）";
    public override string ProjectCtx_AvailableBeingsHint => "提示：优先将已有硅基人分配到角色，而非创建新的。使用 project assign 和 project assign_role。";
    public override string ProjectCtx_AttentionReasonsHeader => "项目需要关注的原因";
    public override string ProjectCtx_UnsatisfiedRolesDetailHeader => "不满足要求的角色详情";
    public override string ProjectAttention_MissingTemplate => "缺少工作流模板";
    public override string ProjectAttention_EmptyRolePool => "角色池为空（尚未分配任何角色）";
    public override string ProjectAttention_UnsatisfiedRoles => "部分角色人员不满足要求";
    ...
    public override string ProjectThinkCycleLabel => "轮次";
    public override string ProjectThinkRoundN => "第 {0} 轮";
}
