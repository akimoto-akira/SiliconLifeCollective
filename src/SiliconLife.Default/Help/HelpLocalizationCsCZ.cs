...
public class HelpLocalizationCsCZ : HelpLocalizationBase
{
  ...
  public override string[] BeingManagement_Tags => new[]
    { "bytost", "vytvořit", "konfigurace", "správa bytostí", "silicon being", "profil", "nastavení", "správa" };

  public override string[] ChatSystem_Tags => new[]
    { "chat", "konverzace", "zpráva", "chatovací systém", "komunikace", "dialog", "rozhovor", "diskuse" };

  public override string[] Dashboard_Tags => new[]
    { "nástěnka", "monitor", "statistiky", "stav", "systém", "frekvence zpráv", "doba běhu", "paměť" };

  public override string[] Task_Tags => new[]
    { "úloha", "práce", "provedení", "priorita", "závislost", "stav", "automatizace", "správa" };

  public override string[] Timer_Tags => new[]
    { "časovač", "plánování", "spouštění", "perioda", "kalendář", "připomínka", "automatický", "časování" };

  public override string[] Permission_Tags => new[]
  {
    "oprávnění", "zabezpečení", "řízení přístupu", "správa oprávnění", "autorizace", "ochrana soukromí", "ochrana",
    "ověření"
  };

  public override string[] Config_Tags => new[]
  {
    "konfigurace", "nastavení", "možnosti", "správa konfigurace", "předvolby", "přizpůsobení", "systém", "parametry"
  };

  public override string[] FAQ_Tags => new[]
    { "časté otázky", "nápověda", "problémy", "podpora", "řešení problémů", "průvodce", "asistence", "odpovědi" };

  public override string[] Memory_Tags => new[]
    { "paměť", "historie", "záznam", "paměťový systém", "aktivita", "vystopování", "vyhledávání", "protokol" };

  public override string[] OllamaSetup_Tags => new[]
    { "Ollama", "instalace", "model", "stažení", "lokální AI", "konfigurace", "nastavení", "spuštění" };
  ...
  {
    "soubor duše", "osobnost", "prompt", "role", "chování", "konfigurace", "charakter", "pracovní průvodce",
    "systémový prompt"
  };

  public override string[] AuditLog_Tags => new[]
    { "protokol auditů", "Token", "statistiky využití", "monitor", "spotřeba", "analýza", "trend", "export", "CSV" };

  public override string[] KnowledgeGraph_Tags => new[]
    { "graf znalostí", "znalosti", "vizualizace", "trojice", "entita", "relace", "síť", "učení", "správa" };

  public override string[] WorkNotes_Tags => new[]
  {
    "pracovní poznámky", "poznámky", "záznamy", "deník", "protokol", "Markdown", "klíčová slova", "verze", "vyhledávání"
  };

  public override string[] Projects_Tags => new[]
    { "správa projektů", "projekt", "spolupráce", "úkol", "člen", "archiv", "tým", "pracovní prostor", "pokrok" };
